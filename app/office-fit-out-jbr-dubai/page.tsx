...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Fit Out in JBR, Dubai",
    "url": "https://interiara.com/office-fit-out-jbr",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Fit Out",
        "item": "https://interiara.com/office-fit-out-jbr"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Fit Out in JBR, Dubai | Interiara",
  description: "Complete office fit out services in JBR. Professional execution & quality assurance. Fast turnaround. Consult now!",
  keywords: [
    "office fit out",
    "office fit out JBR",
  ...
  canonical: "https://interiara.com/office-fit-out-jbr",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JBR Dubai-with-Accouter-Design.webp", alt: "Office Fit Out JBR Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JBR Dubai-2.jpg", alt: "Office Fit Out JBR Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JBR Dubai.jpg", alt: "Office Fit Out JBR Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JBR Dubai-Top-Interior-Designers.jpeg", alt: "Office Fit Out JBR Dubai - Design inspiration" },
  { src: "/JBR Dubai-Bathroom-Design-2.jpg", alt: "Office Fit Out JBR Dubai - JBR Dubai design" },
...
export default function OfficeFitOutJbr() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Office Fit Out JBR Dubai services in JBR Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best office fit Out Jbr Company Out Jbr</p>
