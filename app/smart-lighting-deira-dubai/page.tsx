...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-Deira Dubai-with-Accouter-Design.webp", alt: "Smart Lighting Deira Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Deira Dubai-2.jpg", alt: "Smart Lighting Deira Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Deira Dubai.jpg", alt: "Smart Lighting Deira Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-Deira Dubai-Top-Interior-Designers.jpeg", alt: "Smart Lighting Deira Dubai - Design inspiration" },
  { src: "/Deira Dubai-Bathroom-Design-2.jpg", alt: "Smart Lighting Deira Dubai - Deira Dubai design" },
...
export default function SmartLightingDeira() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Smart Lighting Deira Dubai services in Deira Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best smart Lighting Deira Company Lighting Deira</p>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">
              All Lighting Deira Services
            </h2>
            <p className="text-muted-foreground mb-8">
              Explore our complete range of interior design services available in Lighting Deira. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-3">
              <Link href="/smart-lighting-deira-dubai" className="block text-primary hover:text-primary-dark hover:underline transition-colors duration-200 text-sm font-medium">
                Smart
              </Link>
            </div>
            <div className="space-y-3">
          ...
          <div className="mt-12 pt-8 border-t">
            <p className="text-center text-sm text-muted-foreground">
              Looking for a specific service in Lighting Deira? 
