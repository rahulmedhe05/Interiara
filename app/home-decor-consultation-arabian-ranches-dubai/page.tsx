...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Home Decor Consultation in Arabian Ranches, Dubai",
    "url": "https://interiara.com/home-decor-consultation-arabian-ranches",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Home Decor Consultation",
        "item": "https://interiara.com/home-decor-consultation-arabian-ranches"
      }}
    ]
  }})} />

export const metadata = {
  title: "Home Decor Consultation in Arabian Ranches, Dubai | Interiara",
  description: "Expert home decor consultation in Arabian Ranches, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "home decor consultation",
    "home decor consultation Arabian Ranches",
  ...
  canonical: "https://interiara.com/home-decor-consultation-arabian-ranches",
  twitter: {
