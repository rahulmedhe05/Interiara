...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Soundproofing Design in Arabian Ranches, Dubai",
    "url": "https://interiara.com/soundproofing-design-arabian-ranches",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Soundproofing Design",
        "item": "https://interiara.com/soundproofing-design-arabian-ranches"
      }}
    ]
  }})} />

export const metadata = {
  title: "Soundproofing Design in Arabian Ranches, Dubai | Interiara",
  description: "Expert soundproofing design in Arabian Ranches, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "soundproofing design",
    "soundproofing design Arabian Ranches",
  ...
  canonical: "https://interiara.com/soundproofing-design-arabian-ranches",
  twitter: {
