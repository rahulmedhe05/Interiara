...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Window Curtains in JVT, Dubai",
    "url": "https://interiara.com/window-curtains-jvt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Window Curtains",
        "item": "https://interiara.com/window-curtains-jvt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Window Curtains in JVT, Dubai | Interiara",
  description: "Expert window curtains in JVT, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "window curtains",
    "window curtains JVT",
  ...
  canonical: "https://interiara.com/window-curtains-jvt",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JVT Dubai-with-Accouter-Design.webp", alt: "Window Curtains JVT Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JVT Dubai-2.jpg", alt: "Window Curtains JVT Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JVT Dubai.jpg", alt: "Window Curtains JVT Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JVT Dubai-Top-Interior-Designers.jpeg", alt: "Window Curtains JVT Dubai - Design inspiration" },
  { src: "/JVT Dubai-Bathroom-Design-2.jpg", alt: "Window Curtains JVT Dubai - JVT Dubai design" },
