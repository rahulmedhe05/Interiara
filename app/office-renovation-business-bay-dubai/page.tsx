...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Renovation in Business Bay, Dubai",
    "url": "https://interiara.com/office-renovation-business-bay",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Renovation",
        "item": "https://interiara.com/office-renovation-business-bay"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Renovation in Business Bay, Dubai | Interiara",
  description: "Expert office renovation in Business Bay, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "office renovation",
  ...
  canonical: "https://interiara.com/office-renovation-business-bay",
  twitter: {
