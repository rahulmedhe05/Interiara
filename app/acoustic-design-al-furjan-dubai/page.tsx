...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Acoustic Design in Al Furjan, Dubai",
    "url": "https://interiara.com/acoustic-design-al-furjan",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Acoustic Design",
        "item": "https://interiara.com/acoustic-design-al-furjan"
      }}
    ]
  }})} />

export const metadata = {
  title: "Acoustic Design in Al Furjan, Dubai | Interiara",
  description: "Expert acoustic design in Al Furjan, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "acoustic design",
    "acoustic design Al Furjan",
  ...
  canonical: "https://interiara.com/acoustic-design-al-furjan",
  twitter: {
