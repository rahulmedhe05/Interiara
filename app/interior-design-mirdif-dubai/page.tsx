...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Design in Mirdif, Dubai",
    "url": "https://interiara.com/interior-design-mirdif",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Design",
        "item": "https://interiara.com/interior-design-mirdif"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Design in Mirdif, Dubai | Interiara",
  description: "Transform your space with premium interior design in Mirdif. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "interior design",
  ...
  canonical: "https://interiara.com/interior-design-mirdif",
  twitter: {
