...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Spa Interior Design in Palm Jumeirah, Dubai",
    "url": "https://interiara.com/spa-interior-design-palm-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Spa Interior Design",
        "item": "https://interiara.com/spa-interior-design-palm-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Spa Interior Design in Palm Jumeirah, Dubai | Interiara",
  description: "Transform your space with premium spa interior design in Palm Jumeirah. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "spa interior design",
    "spa interior design Palm Jumeirah",
  ...
  canonical: "https://interiara.com/spa-interior-design-palm-jumeirah",
  twitter: {
