...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Showroom Interior Design in Springs, Dubai",
    "url": "https://interiara.com/showroom-interior-design-springs",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Showroom Interior Design",
        "item": "https://interiara.com/showroom-interior-design-springs"
      }}
    ]
  }})} />

export const metadata = {
  title: "Showroom Interior Design in Springs, Dubai | Interiara",
  description: "Transform your space with premium showroom interior design in Springs. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "showroom interior design",
    "showroom interior design Springs",
  ...
  canonical: "https://interiara.com/showroom-interior-design-springs",
  twitter: {
