...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wall Coverings in Nad Al Sheba, Dubai",
    "url": "https://interiara.com/wall-coverings-nad-al-sheba",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wall Coverings",
        "item": "https://interiara.com/wall-coverings-nad-al-sheba"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wall Coverings in Nad Al Sheba, Dubai | Interiara",
  description: "Expert wall coverings in Nad Al Sheba, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wall coverings",
    "wall coverings Nad Al Sheba",
  ...
  canonical: "https://interiara.com/wall-coverings-nad-al-sheba",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-Nad Al Sheba Dubai-with-Accouter-Design.webp", alt: "Wall Coverings Nad Al Sheba Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Nad Al Sheba Dubai-2.jpg", alt: "Wall Coverings Nad Al Sheba Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Nad Al Sheba Dubai.jpg", alt: "Wall Coverings Nad Al Sheba Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-Nad Al Sheba Dubai-Top-Interior-Designers.jpeg", alt: "Wall Coverings Nad Al Sheba Dubai - Design inspiration" },
  { src: "/Nad Al Sheba Dubai-Bathroom-Design-2.jpg", alt: "Wall Coverings Nad Al Sheba Dubai - Nad Al Sheba Dubai design" },
...
export default function WallCoveringsNadAlSheba() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Wall Coverings Nad Al Sheba Dubai services in Nad Al Sheba Dubai. Please share more details.")
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              ...
              <p className="text-lg text-muted-foreground mb-6 lg:mb-8 leading-relaxed">
                Looking for professional <strong>Wall Coverings Nad Al Sheba Dubai</strong>? Interiara is Nad Al Sheba Dubai's premier <strong>Wall Coverings Nad Al Sheba Dubai company</strong>, specializing in creating beautiful, functional spaces. With 300+ projects completed and 15+ years of experience, we deliver exceptional results tailored to your needs.
              </p>
