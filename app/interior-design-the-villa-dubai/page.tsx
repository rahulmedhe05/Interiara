...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Design in The Villa, Dubai",
    "url": "https://interiara.com/interior-design-the-villa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Design",
        "item": "https://interiara.com/interior-design-the-villa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Design in The Villa, Dubai | Interiara",
  description: "Transform your space with premium interior design in The Villa. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "interior design",
  ...
  canonical: "https://interiara.com/interior-design-the-villa",
  twitter: {
