...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Drapes in Umm Suqeim, Dubai",
    "url": "https://interiara.com/drapes-umm-suqeim",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Drapes",
        "item": "https://interiara.com/drapes-umm-suqeim"
      }}
    ]
  }})} />

export const metadata = {
  title: "Drapes in Umm Suqeim, Dubai | Interiara",
  description: "Expert drapes in Umm Suqeim, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "drapes",
    "drapes Umm Suqeim",
  ...
  canonical: "https://interiara.com/drapes-umm-suqeim",
  twitter: {
