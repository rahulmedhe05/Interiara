...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Design in City Walk, Dubai",
    "url": "https://interiara.com/interior-design-city-walk",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Design",
        "item": "https://interiara.com/interior-design-city-walk"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Design in City Walk, Dubai | Interiara",
  description: "Transform your space with premium interior design in City Walk. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "interior design",
  ...
  canonical: "https://interiara.com/interior-design-city-walk",
  twitter: {
