...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Home Decor Consultation in City Walk, Dubai",
    "url": "https://interiara.com/home-decor-consultation-city-walk",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Home Decor Consultation",
        "item": "https://interiara.com/home-decor-consultation-city-walk"
      }}
    ]
  }})} />

export const metadata = {
  title: "Home Decor Consultation in City Walk, Dubai | Interiara",
  description: "Expert home decor consultation in City Walk, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "home decor consultation",
    "home decor consultation City Walk",
  ...
  canonical: "https://interiara.com/home-decor-consultation-city-walk",
  twitter: {
