...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wall Coverings in Umm Suqeim, Dubai",
    "url": "https://interiara.com/wall-coverings-umm-suqeim",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wall Coverings",
        "item": "https://interiara.com/wall-coverings-umm-suqeim"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wall Coverings in Umm Suqeim, Dubai | Interiara",
  description: "Expert wall coverings in Umm Suqeim, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wall coverings",
    "wall coverings Umm Suqeim",
  ...
  canonical: "https://interiara.com/wall-coverings-umm-suqeim",
  twitter: {
