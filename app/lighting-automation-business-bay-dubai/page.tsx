...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Lighting Automation in Business Bay, Dubai",
    "url": "https://interiara.com/lighting-automation-business-bay",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Lighting Automation",
        "item": "https://interiara.com/lighting-automation-business-bay"
      }}
    ]
  }})} />

export const metadata = {
  title: "Lighting Automation in Business Bay, Dubai | Interiara",
  description: "Expert lighting automation in Business Bay, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "lighting automation",
    "lighting automation Business Bay",
  ...
  canonical: "https://interiara.com/lighting-automation-business-bay",
  twitter: {
