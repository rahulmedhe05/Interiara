...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Art Consultation in Al Quoz, Dubai",
    "url": "https://interiara.com/art-consultation-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Art Consultation",
        "item": "https://interiara.com/art-consultation-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Art Consultation in Al Quoz, Dubai | Interiara",
  description: "Expert art consultation in Al Quoz, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "art consultation",
    "art consultation Al Quoz",
  ...
  canonical: "https://interiara.com/art-consultation-al-quoz",
  twitter: {
