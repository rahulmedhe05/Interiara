...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Bespoke Furniture Design in Arabian Ranches, Dubai",
    "url": "https://interiara.com/bespoke-furniture-design-arabian-ranches",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Bespoke Furniture Design",
        "item": "https://interiara.com/bespoke-furniture-design-arabian-ranches"
      }}
    ]
  }})} />

export const metadata = {
  title: "Bespoke Furniture Design in Arabian Ranches, Dubai | Interiara",
  description: "Expert bespoke furniture design in Arabian Ranches, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "bespoke furniture design",
    "bespoke furniture design Arabian Ranches",
  ...
  canonical: "https://interiara.com/bespoke-furniture-design-arabian-ranches",
  twitter: {
