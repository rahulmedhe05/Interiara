...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Living Room Interior Design in Mirdif, Dubai",
    "url": "https://interiara.com/living-room-interior-design-mirdif",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Living Room Interior Design",
        "item": "https://interiara.com/living-room-interior-design-mirdif"
      }}
    ]
  }})} />

export const metadata = {
  title: "Living Room Interior Design in Mirdif, Dubai | Interiara",
  description: "Transform your space with premium living room interior design in Mirdif. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "living room interior design",
    "living room interior design Mirdif",
  ...
  canonical: "https://interiara.com/living-room-interior-design-mirdif",
  twitter: {
