...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Bespoke Furniture Design in Al Wasl, Dubai",
    "url": "https://interiara.com/bespoke-furniture-design-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Bespoke Furniture Design",
        "item": "https://interiara.com/bespoke-furniture-design-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Bespoke Furniture Design in Al Wasl, Dubai | Interiara",
  description: "Expert bespoke furniture design in Al Wasl, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "bespoke furniture design",
    "bespoke furniture design Al Wasl",
  ...
  canonical: "https://interiara.com/bespoke-furniture-design-al-wasl",
  twitter: {
