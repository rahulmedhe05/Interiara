...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Commercial Interior Design in Mirdif, Dubai",
    "url": "https://interiara.com/commercial-interior-design-mirdif",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Commercial Interior Design",
        "item": "https://interiara.com/commercial-interior-design-mirdif"
      }}
    ]
  }})} />

export const metadata = {
  title: "Commercial Interior Design in Mirdif, Dubai | Interiara",
  description: "Transform your space with premium commercial interior design in Mirdif. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "commercial interior design",
    "commercial interior design Mirdif",
  ...
  canonical: "https://interiara.com/commercial-interior-design-mirdif",
  twitter: {
