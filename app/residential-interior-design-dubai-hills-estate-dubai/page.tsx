...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Residential Interior Design in Dubai Hills Estate, Dubai",
    "url": "https://interiara.com/residential-interior-design-dubai-hills-estate",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Residential Interior Design",
        "item": "https://interiara.com/residential-interior-design-dubai-hills-estate"
      }}
    ]
  }})} />

export const metadata = {
  title: "Residential Interior Design in Dubai Hills Estate, Dubai | Interiara",
  description: "Transform your space with premium residential interior design in Dubai Hills Estate. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/residential-interior-design-dubai-hills-estate",
  twitter: {
