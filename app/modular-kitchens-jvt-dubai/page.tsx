...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Modular Kitchens in JVT, Dubai",
    "url": "https://interiara.com/modular-kitchens-jvt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Modular Kitchens",
        "item": "https://interiara.com/modular-kitchens-jvt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Modular Kitchens in JVT, Dubai | Interiara",
  description: "Premium modular kitchens in JVT. Innovative designs with quality materials. Space-efficient solutions. Quote today!",
  keywords: [
    "modular kitchens",
    "modular kitchens JVT",
  ...
  canonical: "https://interiara.com/modular-kitchens-jvt",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JVT Dubai-with-Accouter-Design.webp", alt: "Modular Kitchens JVT Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JVT Dubai-2.jpg", alt: "Modular Kitchens JVT Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JVT Dubai.jpg", alt: "Modular Kitchens JVT Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JVT Dubai-Top-Interior-Designers.jpeg", alt: "Modular Kitchens JVT Dubai - Design inspiration" },
  { src: "/JVT Dubai-Bathroom-Design-2.jpg", alt: "Modular Kitchens JVT Dubai - JVT Dubai design" },
...
export default function ModularKitchensJvt() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Modular Kitchens JVT Dubai services in JVT Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best modular Kitchens Jvt Company Kitchens Jvt</p>
