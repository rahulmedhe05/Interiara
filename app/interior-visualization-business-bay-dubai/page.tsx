...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Visualization in Business Bay, Dubai",
    "url": "https://interiara.com/interior-visualization-business-bay",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Visualization",
        "item": "https://interiara.com/interior-visualization-business-bay"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Visualization in Business Bay, Dubai | Interiara",
  description: "Expert interior visualization in Business Bay, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "interior visualization",
    "interior visualization Business Bay",
  ...
  canonical: "https://interiara.com/interior-visualization-business-bay",
  twitter: {
