...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Art Consultation in The Villa, Dubai",
    "url": "https://interiara.com/art-consultation-the-villa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Art Consultation",
        "item": "https://interiara.com/art-consultation-the-villa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Art Consultation in The Villa, Dubai | Interiara",
  description: "Expert art consultation in The Villa, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "art consultation",
  ...
  canonical: "https://interiara.com/art-consultation-the-villa",
  twitter: {
