...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Lighting Automation in Arabian Ranches, Dubai",
    "url": "https://interiara.com/lighting-automation-arabian-ranches",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Lighting Automation",
        "item": "https://interiara.com/lighting-automation-arabian-ranches"
      }}
    ]
  }})} />

export const metadata = {
  title: "Lighting Automation in Arabian Ranches, Dubai | Interiara",
  description: "Expert lighting automation in Arabian Ranches, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "lighting automation",
    "lighting automation Arabian Ranches",
  ...
  canonical: "https://interiara.com/lighting-automation-arabian-ranches",
  twitter: {
