...
// SEO Keywords: Space Planning Dubai Festival City, Space Planning Dubai Festival City Dubai, best Space Planning in Dubai Festival City, professional Space Planning Dubai Festival City, expert Space Planning Dubai Festival City Dubai, Space Planning services Dubai Festival City, Space Planning company Dubai Festival City, Space Planning specialist Dubai Festival City
...
const galleryImages = [
  ...
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Space Planning Dubai Festival City - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Space Planning Dubai Festival City - Professional design" },
]

export const metadata = {
  title: "Space Planning in Dubai Festival City Dubai | Expert Interior Design Services",
  ...
  keywords: "Space Planning Dubai Festival City, Space Planning Dubai Festival City Dubai, best Space Planning in Dubai Festival City, professional Space Planning Dubai Festival City, expert Space Planning Dubai Festival City Dubai, Space Planning services Dubai Festival City, Space Planning company Dubai Festival City, Space Planning specialist Dubai Festival City",
  openGraph: {
    title: "Space Planning in Dubai Festival City Dubai",
    description: "Expert Space Planning services in Dubai Festival City, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Space Planning in Dubai Festival City",
      },
    ],
  },
  robots: "index, follow",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Space Planning services in Dubai Festival City. Please share more details and pricing."
  )
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Space Planning in Dubai Festival City?
...
Dubai Festival City residents and businesses benefit from professional space planning that considers:
...
Our Dubai Festival City team understands these unique factors, delivering space planning solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Space Planning in Dubai Festival City?
...
Professional space planning in Dubai Festival City offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert space planning can create your perfect Dubai Festival City environment. Schedule your free consultation now.
          </p>
