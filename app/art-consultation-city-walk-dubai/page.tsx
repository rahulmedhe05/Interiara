...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Art Consultation in City Walk, Dubai",
    "url": "https://interiara.com/art-consultation-city-walk",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Art Consultation",
        "item": "https://interiara.com/art-consultation-city-walk"
      }}
    ]
  }})} />

export const metadata = {
  title: "Art Consultation in City Walk, Dubai | Interiara",
  description: "Expert art consultation in City Walk, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "art consultation",
    "art consultation City Walk",
  ...
  canonical: "https://interiara.com/art-consultation-city-walk",
  twitter: {
