...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Salon Interior Design in JLT, Dubai",
    "url": "https://interiara.com/salon-interior-design-jlt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Salon Interior Design",
        "item": "https://interiara.com/salon-interior-design-jlt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Salon Interior Design in JLT, Dubai | Interiara",
  description: "Transform your space with premium salon interior design in JLT. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/salon-interior-design-jlt",
  twitter: {
