...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wall Flooring Design in Palm Jumeirah, Dubai",
    "url": "https://interiara.com/wall-flooring-design-palm-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wall Flooring Design",
        "item": "https://interiara.com/wall-flooring-design-palm-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wall Flooring Design in Palm Jumeirah, Dubai | Interiara",
  description: "Expert wall flooring design in Palm Jumeirah, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wall flooring design",
    "wall flooring design Palm Jumeirah",
  ...
  canonical: "https://interiara.com/wall-flooring-design-palm-jumeirah",
  twitter: {
