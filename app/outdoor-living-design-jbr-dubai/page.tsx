...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Outdoor Living Design in JBR, Dubai",
    "url": "https://interiara.com/outdoor-living-design-jbr",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Outdoor Living Design",
        "item": "https://interiara.com/outdoor-living-design-jbr"
      }}
    ]
  }})} />

export const metadata = {
  title: "Outdoor Living Design in JBR, Dubai | Interiara",
  description: "Beautiful outdoor living design in JBR. Stunning outdoor spaces for relaxation & entertainment. Expert design & build!",
  keywords: [
    "outdoor living design",
    "outdoor living design JBR",
  ...
  canonical: "https://interiara.com/outdoor-living-design-jbr",
  twitter: {
