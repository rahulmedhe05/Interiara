...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Balcony Interior Design in Umm Suqeim, Dubai",
    "url": "https://interiara.com/balcony-interior-design-umm-suqeim",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Balcony Interior Design",
        "item": "https://interiara.com/balcony-interior-design-umm-suqeim"
      }}
    ]
  }})} />

export const metadata = {
  title: "Balcony Interior Design in Umm Suqeim, Dubai | Interiara",
  description: "Transform your space with premium balcony interior design in Umm Suqeim. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "balcony interior design",
    "balcony interior design Umm Suqeim",
  ...
  canonical: "https://interiara.com/balcony-interior-design-umm-suqeim",
  twitter: {
