...
export const metadata: Metadata = {
  title: "Modular Kitchens Downtown Dubai | Premium Design Services Downtown Dubai | Interiara",
  description: "Professional modular kitchens downtown dubai services in Downtown Dubai. Transform your space with our expert design team. Contact us for a free consultation and custom design proposal.",
  keywords: [
    "modular-kitchens-downtown-dubai", "modular kitchens downtown dubai", "modular kitchens downtown dubai services", "best modular kitchens downtown dubai", "professional modular kitchens downtown dubai", "modular kitchens downtown dubai company downtown dubai", "modular kitchens downtown dubai specialist", "expert modular kitchens downtown dubai",
  ],
  openGraph: {
