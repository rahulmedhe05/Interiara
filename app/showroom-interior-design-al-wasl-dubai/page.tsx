...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Showroom Interior Design in Al Wasl, Dubai",
    "url": "https://interiara.com/showroom-interior-design-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Showroom Interior Design",
        "item": "https://interiara.com/showroom-interior-design-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Showroom Interior Design in Al Wasl, Dubai | Interiara",
  description: "Transform your space with premium showroom interior design in Al Wasl. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "showroom interior design",
    "showroom interior design Al Wasl",
  ...
  canonical: "https://interiara.com/showroom-interior-design-al-wasl",
  twitter: {
