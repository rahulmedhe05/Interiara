...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Sustainable Interior Design in Mirdif, Dubai",
    "url": "https://interiara.com/sustainable-interior-design-mirdif",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Sustainable Interior Design",
        "item": "https://interiara.com/sustainable-interior-design-mirdif"
      }}
    ]
  }})} />

export const metadata = {
  title: "Sustainable Interior Design in Mirdif, Dubai | Interiara",
  description: "Transform your space with premium sustainable interior design in Mirdif. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "sustainable interior design",
    "sustainable interior design Mirdif",
  ...
  canonical: "https://interiara.com/sustainable-interior-design-mirdif",
  twitter: {
