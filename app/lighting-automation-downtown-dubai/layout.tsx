...
export const metadata: Metadata = {
  title: "Lighting Automation Downtown Dubai | Premium Design Services Downtown Dubai | Interiara",
  description: "Professional lighting automation downtown dubai services in Downtown Dubai. Transform your space with our expert design team. Contact us for a free consultation and custom design proposal.",
  keywords: [
    "lighting-automation-downtown-dubai", "lighting automation downtown dubai", "lighting automation downtown dubai services", "best lighting automation downtown dubai", "professional lighting automation downtown dubai", "lighting automation downtown dubai company downtown dubai", "lighting automation downtown dubai specialist", "expert lighting automation downtown dubai",
  ],
  openGraph: {
