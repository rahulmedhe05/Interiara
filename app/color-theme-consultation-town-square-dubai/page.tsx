...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Color Theme Consultation in Town Square, Dubai",
    "url": "https://interiara.com/color-theme-consultation-town-square",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Color Theme Consultation",
        "item": "https://interiara.com/color-theme-consultation-town-square"
      }}
    ]
  }})} />

export const metadata = {
  title: "Color Theme Consultation in Town Square, Dubai | Interiara",
  description: "Expert color theme consultation in Town Square, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "color theme consultation",
    "color theme consultation Town Square",
  ...
  canonical: "https://interiara.com/color-theme-consultation-town-square",
  twitter: {
