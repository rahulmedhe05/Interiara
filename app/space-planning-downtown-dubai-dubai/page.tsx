...
// SEO Keywords: Space Planning Downtown Dubai, Space Planning Downtown Dubai Dubai, best Space Planning in Downtown Dubai, professional Space Planning Downtown Dubai, expert Space Planning Downtown Dubai Dubai, Space Planning services Downtown Dubai, Space Planning company Downtown Dubai, Space Planning specialist Downtown Dubai
...
const galleryImages = [
  ...
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Space Planning Downtown Dubai - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Space Planning Downtown Dubai - Professional design" },
]

export const metadata = {
  title: "Space Planning in Downtown Dubai Dubai | Expert Interior Design Services",
  ...
  keywords: "Space Planning Downtown Dubai, Space Planning Downtown Dubai Dubai, best Space Planning in Downtown Dubai, professional Space Planning Downtown Dubai, expert Space Planning Downtown Dubai Dubai, Space Planning services Downtown Dubai, Space Planning company Downtown Dubai, Space Planning specialist Downtown Dubai",
  openGraph: {
    title: "Space Planning in Downtown Dubai Dubai",
    description: "Expert Space Planning services in Downtown Dubai, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Space Planning in Downtown Dubai",
      },
    ],
  },
  robots: "index, follow",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Space Planning services in Downtown Dubai. Please share more details and pricing."
  )
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Space Planning in Downtown Dubai?
...
Downtown Dubai residents and businesses benefit from professional space planning that considers:
...
Our Downtown Dubai team understands these unique factors, delivering space planning solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Space Planning in Downtown Dubai?
...
Professional space planning in Downtown Dubai offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert space planning can create your perfect Downtown Dubai environment. Schedule your free consultation now.
          </p>
