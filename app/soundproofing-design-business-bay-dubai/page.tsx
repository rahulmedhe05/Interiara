...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Soundproofing Design in Business Bay, Dubai",
    "url": "https://interiara.com/soundproofing-design-business-bay",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Soundproofing Design",
        "item": "https://interiara.com/soundproofing-design-business-bay"
      }}
    ]
  }})} />

export const metadata = {
  title: "Soundproofing Design in Business Bay, Dubai | Interiara",
  description: "Expert soundproofing design in Business Bay, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "soundproofing design",
    "soundproofing design Business Bay",
  ...
  canonical: "https://interiara.com/soundproofing-design-business-bay",
  twitter: {
