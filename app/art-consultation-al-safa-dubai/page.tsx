...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Art Consultation in Al Safa, Dubai",
    "url": "https://interiara.com/art-consultation-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Art Consultation",
        "item": "https://interiara.com/art-consultation-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Art Consultation in Al Safa, Dubai | Interiara",
  description: "Expert art consultation in Al Safa, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "art consultation",
    "art consultation Al Safa",
  ...
  canonical: "https://interiara.com/art-consultation-al-safa",
  twitter: {
