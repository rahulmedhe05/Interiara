...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Spa Interior Design in Al Quoz, Dubai",
    "url": "https://interiara.com/spa-interior-design-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Spa Interior Design",
        "item": "https://interiara.com/spa-interior-design-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Spa Interior Design in Al Quoz, Dubai | Interiara",
  description: "Transform your space with premium spa interior design in Al Quoz. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "spa interior design",
    "spa interior design Al Quoz",
  ...
  canonical: "https://interiara.com/spa-interior-design-al-quoz",
  twitter: {
