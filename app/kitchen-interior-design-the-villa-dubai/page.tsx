...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Kitchen Interior Design in The Villa, Dubai",
    "url": "https://interiara.com/kitchen-interior-design-the-villa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Kitchen Interior Design",
        "item": "https://interiara.com/kitchen-interior-design-the-villa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Kitchen Interior Design in The Villa, Dubai | Interiara",
  description: "Transform your space with premium kitchen interior design in The Villa. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/kitchen-interior-design-the-villa",
  twitter: {
