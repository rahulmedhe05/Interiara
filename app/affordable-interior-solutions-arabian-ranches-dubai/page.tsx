...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Affordable Interior Solutions in Arabian Ranches, Dubai",
    "url": "https://interiara.com/affordable-interior-solutions-arabian-ranches",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Affordable Interior Solutions",
        "item": "https://interiara.com/affordable-interior-solutions-arabian-ranches"
      }}
    ]
  }})} />

export const metadata = {
  title: "Affordable Interior Solutions in Arabian Ranches, Dubai | Interiara",
  description: "Expert affordable interior solutions in Arabian Ranches, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "affordable interior solutions",
    "affordable interior solutions Arabian Ranches",
  ...
  canonical: "https://interiara.com/affordable-interior-solutions-arabian-ranches",
  twitter: {
