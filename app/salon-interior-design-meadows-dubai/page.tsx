...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Salon Interior Design in Meadows, Dubai",
    "url": "https://interiara.com/salon-interior-design-meadows",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Salon Interior Design",
        "item": "https://interiara.com/salon-interior-design-meadows"
      }}
    ]
  }})} />

export const metadata = {
  title: "Salon Interior Design in Meadows, Dubai | Interiara",
  description: "Transform your space with premium salon interior design in Meadows. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "salon interior design",
    "salon interior design Meadows",
  ...
  canonical: "https://interiara.com/salon-interior-design-meadows",
  twitter: {
