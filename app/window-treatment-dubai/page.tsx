...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-Treatment Dubai-with-Accouter-Design.webp", alt: "Window Treatment Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Treatment Dubai-2.jpg", alt: "Window Treatment Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Treatment Dubai.jpg", alt: "Window Treatment Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-Treatment Dubai-Top-Interior-Designers.jpeg", alt: "Window Treatment Dubai - Design inspiration" },
  { src: "/Treatment Dubai-Bathroom-Design-2.jpg", alt: "Window Treatment Dubai - Treatment Dubai design" },
...
export default function WindowTreatment() {
  const [showAllImages, setShowAllImages] = useState(false)
  const whatsappNumber = "916353583148"
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Window Treatment Dubai services in Treatment Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">
              All Window Treatment Services
            </h2>
            <p className="text-muted-foreground mb-8">
              Explore our complete range of interior design services available in Window Treatment. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-3">
              <Link href="/window-treatment-dubai" className="block text-primary hover:text-primary-dark hover:underline transition-colors duration-200 text-sm font-medium">
          ...
          <div className="mt-12 pt-8 border-t">
            <p className="text-center text-sm text-muted-foreground">
              Looking for a specific service in Window Treatment? 
