...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Drapes in Al Wasl, Dubai",
    "url": "https://interiara.com/drapes-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Drapes",
        "item": "https://interiara.com/drapes-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Drapes in Al Wasl, Dubai | Interiara",
  description: "Expert drapes in Al Wasl, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "drapes",
    "drapes Al Wasl",
  ...
  canonical: "https://interiara.com/drapes-al-wasl",
  twitter: {
