...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Penthouse Interior Design in Al Barsha, Dubai",
    "url": "https://interiara.com/penthouse-interior-design-al-barsha",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Penthouse Interior Design",
        "item": "https://interiara.com/penthouse-interior-design-al-barsha"
      }}
    ]
  }})} />

export const metadata = {
  title: "Penthouse Interior Design in Al Barsha, Dubai | Interiara",
  description: "Transform your space with premium penthouse interior design in Al Barsha. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "penthouse interior design",
    "penthouse interior design Al Barsha",
  ...
  canonical: "https://interiara.com/penthouse-interior-design-al-barsha",
  twitter: {
