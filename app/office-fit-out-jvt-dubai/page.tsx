...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Fit Out in JVT, Dubai",
    "url": "https://interiara.com/office-fit-out-jvt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Fit Out",
        "item": "https://interiara.com/office-fit-out-jvt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Fit Out in JVT, Dubai | Interiara",
  description: "Complete office fit out services in JVT. Professional execution & quality assurance. Fast turnaround. Consult now!",
  keywords: [
    "office fit out",
    "office fit out JVT",
  ...
  canonical: "https://interiara.com/office-fit-out-jvt",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JVT Dubai-with-Accouter-Design.webp", alt: "Office Fit Out JVT Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JVT Dubai-2.jpg", alt: "Office Fit Out JVT Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JVT Dubai.jpg", alt: "Office Fit Out JVT Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JVT Dubai-Top-Interior-Designers.jpeg", alt: "Office Fit Out JVT Dubai - Design inspiration" },
  { src: "/JVT Dubai-Bathroom-Design-2.jpg", alt: "Office Fit Out JVT Dubai - JVT Dubai design" },
...
export default function OfficeFitOutJvt() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Office Fit Out JVT Dubai services in JVT Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best office fit Out Jvt Company Out Jvt</p>
