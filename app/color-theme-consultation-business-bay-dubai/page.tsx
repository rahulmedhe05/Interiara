...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Color Theme Consultation in Business Bay, Dubai",
    "url": "https://interiara.com/color-theme-consultation-business-bay",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Color Theme Consultation",
        "item": "https://interiara.com/color-theme-consultation-business-bay"
      }}
    ]
  }})} />

export const metadata = {
  title: "Color Theme Consultation in Business Bay, Dubai | Interiara",
  description: "Expert color theme consultation in Business Bay, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "color theme consultation",
    "color theme consultation Business Bay",
  ...
  canonical: "https://interiara.com/color-theme-consultation-business-bay",
  twitter: {
