...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Restaurant Interior Design in Jumeirah, Dubai",
    "url": "https://interiara.com/restaurant-interior-design-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Restaurant Interior Design",
        "item": "https://interiara.com/restaurant-interior-design-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Restaurant Interior Design in Jumeirah, Dubai | Interiara",
  description: "Transform your space with premium restaurant interior design in Jumeirah. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "restaurant interior design",
    "restaurant interior design Jumeirah",
  ...
  canonical: "https://interiara.com/restaurant-interior-design-jumeirah",
  twitter: {
