...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Drapes in JVC, Dubai",
    "url": "https://interiara.com/drapes-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Drapes",
        "item": "https://interiara.com/drapes-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Drapes in JVC, Dubai | Interiara",
  description: "Expert drapes in JVC, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "drapes",
    "drapes JVC",
    "drapes JVC Dubai",
  ...
  canonical: "https://interiara.com/drapes-jvc",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JVC Dubai-with-Accouter-Design.webp", alt: "Drapes JVC Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JVC Dubai-2.jpg", alt: "Drapes JVC Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JVC Dubai.jpg", alt: "Drapes JVC Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JVC Dubai-Top-Interior-Designers.jpeg", alt: "Drapes JVC Dubai - Design inspiration" },
  { src: "/JVC Dubai-Bathroom-Design-2.jpg", alt: "Drapes JVC Dubai - JVC Dubai design" },
...
export default function DrapesJvc() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Drapes JVC Dubai services in JVC Dubai. Please share more details.")
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              ...
              <p className="text-lg text-muted-foreground mb-6 lg:mb-8 leading-relaxed">
                Looking for professional <strong>Drapes JVC Dubai</strong>? Interiara is JVC Dubai's premier <strong>Drapes JVC Dubai company</strong>, specializing in creating beautiful, functional spaces. With 300+ projects completed and 15+ years of experience, we deliver exceptional results tailored to your needs.
              </p>
