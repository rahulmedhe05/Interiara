...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Drapes in Town Square, Dubai",
    "url": "https://interiara.com/drapes-town-square",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Drapes",
        "item": "https://interiara.com/drapes-town-square"
      }}
    ]
  }})} />

export const metadata = {
  title: "Drapes in Town Square, Dubai | Interiara",
  description: "Expert drapes in Town Square, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "drapes",
    "drapes Town Square",
  ...
  canonical: "https://interiara.com/drapes-town-square",
  twitter: {
