...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Window Curtains in Al Furjan, Dubai",
    "url": "https://interiara.com/window-curtains-al-furjan",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Window Curtains",
        "item": "https://interiara.com/window-curtains-al-furjan"
      }}
    ]
  }})} />

export const metadata = {
  title: "Window Curtains in Al Furjan, Dubai | Interiara",
  description: "Expert window curtains in Al Furjan, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "window curtains",
    "window curtains Al Furjan",
  ...
  canonical: "https://interiara.com/window-curtains-al-furjan",
  twitter: {
