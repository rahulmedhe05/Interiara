...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Media Room Interior Design in Al Wasl, Dubai",
    "url": "https://interiara.com/media-room-interior-design-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Media Room Interior Design",
        "item": "https://interiara.com/media-room-interior-design-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Media Room Interior Design in Al Wasl, Dubai | Interiara",
  description: "Transform your space with premium media room interior design in Al Wasl. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "media room interior design",
    "media room interior design Al Wasl",
  ...
  canonical: "https://interiara.com/media-room-interior-design-al-wasl",
  twitter: {
