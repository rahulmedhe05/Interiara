...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Showroom Interior Design in Palm Jumeirah, Dubai",
    "url": "https://interiara.com/showroom-interior-design-palm-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Showroom Interior Design",
        "item": "https://interiara.com/showroom-interior-design-palm-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Showroom Interior Design in Palm Jumeirah, Dubai | Interiara",
  description: "Transform your space with premium showroom interior design in Palm Jumeirah. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "showroom interior design",
    "showroom interior design Palm Jumeirah",
  ...
  canonical: "https://interiara.com/showroom-interior-design-palm-jumeirah",
  twitter: {
