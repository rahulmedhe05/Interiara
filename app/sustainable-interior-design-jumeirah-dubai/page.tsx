...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Sustainable Interior Design in Jumeirah, Dubai",
    "url": "https://interiara.com/sustainable-interior-design-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Sustainable Interior Design",
        "item": "https://interiara.com/sustainable-interior-design-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Sustainable Interior Design in Jumeirah, Dubai | Interiara",
  description: "Transform your space with premium sustainable interior design in Jumeirah. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "sustainable interior design",
    "sustainable interior design Jumeirah",
  ...
  canonical: "https://interiara.com/sustainable-interior-design-jumeirah",
  twitter: {
