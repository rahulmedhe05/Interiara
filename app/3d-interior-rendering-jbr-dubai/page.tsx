...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JBR Dubai-with-Accouter-Design.webp", alt: "3D Interior Rendering JBR Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JBR Dubai-2.jpg", alt: "3D Interior Rendering JBR Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JBR Dubai.jpg", alt: "3D Interior Rendering JBR Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JBR Dubai-Top-Interior-Designers.jpeg", alt: "3D Interior Rendering JBR Dubai - Design inspiration" },
  { src: "/JBR Dubai-Bathroom-Design-2.jpg", alt: "3D Interior Rendering JBR Dubai - JBR Dubai design" },
...
export default function 3DInteriorRenderingJbr() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in 3D Interior Rendering JBR Dubai services in JBR Dubai. Please share more details.")
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              ...
              <p className="text-lg text-muted-foreground mb-6 lg:mb-8 leading-relaxed">
                Looking for professional <strong>3D Interior Rendering JBR Dubai</strong>? Interiara is JBR Dubai's premier <strong>3D Interior Rendering JBR Dubai company</strong>, specializing in creating beautiful, functional spaces. With 300+ projects completed and 15+ years of experience, we deliver exceptional results tailored to your needs.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">
              All Rendering Jbr Services
            </h2>
            <p className="text-muted-foreground mb-8">
              Explore our complete range of interior design services available in Rendering Jbr. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-3">
              <Link href="/3d-interior-rendering-jbr-dubai" className="block text-primary hover:text-primary-dark hover:underline transition-colors duration-200 text-sm font-medium">
                3D Interior
              </Link>
            </div>
            <div className="space-y-3">
          ...
          <div className="mt-12 pt-8 border-t">
            <p className="text-center text-sm text-muted-foreground">
              Looking for a specific service in Rendering Jbr? 
