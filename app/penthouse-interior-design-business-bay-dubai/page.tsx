...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Penthouse Interior Design in Business Bay, Dubai",
    "url": "https://interiara.com/penthouse-interior-design-business-bay",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Penthouse Interior Design",
        "item": "https://interiara.com/penthouse-interior-design-business-bay"
      }}
    ]
  }})} />

export const metadata = {
  title: "Penthouse Interior Design in Business Bay, Dubai | Interiara",
  description: "Transform your space with premium penthouse interior design in Business Bay. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "penthouse interior design",
    "penthouse interior design Business Bay",
  ...
  canonical: "https://interiara.com/penthouse-interior-design-business-bay",
  twitter: {
