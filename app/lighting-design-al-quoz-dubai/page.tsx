...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Lighting Design in Al Quoz, Dubai",
    "url": "https://interiara.com/lighting-design-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Lighting Design",
        "item": "https://interiara.com/lighting-design-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Lighting Design in Al Quoz, Dubai | Interiara",
  description: "Professional lighting design in Al Quoz. Enhance ambiance & functionality with expert lighting. Free consultation available!",
  keywords: [
    "lighting design",
    "lighting design Al Quoz",
  ...
  canonical: "https://interiara.com/lighting-design-al-quoz",
  twitter: {
