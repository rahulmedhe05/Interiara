...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Window Blinds in Al Safa, Dubai",
    "url": "https://interiara.com/window-blinds-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Window Blinds",
        "item": "https://interiara.com/window-blinds-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Window Blinds in Al Safa, Dubai | Interiara",
  description: "Expert window blinds in Al Safa, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "window blinds",
    "window blinds Al Safa",
  ...
  canonical: "https://interiara.com/window-blinds-al-safa",
  twitter: {
