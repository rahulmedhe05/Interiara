...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Window Curtains in Al Quoz, Dubai",
    "url": "https://interiara.com/window-curtains-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Window Curtains",
        "item": "https://interiara.com/window-curtains-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Window Curtains in Al Quoz, Dubai | Interiara",
  description: "Expert window curtains in Al Quoz, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "window curtains",
    "window curtains Al Quoz",
  ...
  canonical: "https://interiara.com/window-curtains-al-quoz",
  twitter: {
