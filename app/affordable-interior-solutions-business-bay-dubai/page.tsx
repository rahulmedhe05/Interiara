...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Affordable Interior Solutions in Business Bay, Dubai",
    "url": "https://interiara.com/affordable-interior-solutions-business-bay",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Affordable Interior Solutions",
        "item": "https://interiara.com/affordable-interior-solutions-business-bay"
      }}
    ]
  }})} />

export const metadata = {
  title: "Affordable Interior Solutions in Business Bay, Dubai | Interiara",
  description: "Expert affordable interior solutions in Business Bay, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "affordable interior solutions",
    "affordable interior solutions Business Bay",
  ...
  canonical: "https://interiara.com/affordable-interior-solutions-business-bay",
  twitter: {
