...
const galleryImages = [
  { src: "/dubai-interior-design-luxury.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Luxury design" },
  { src: "/Reception-9.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Closet Design Sheikh Zayed Road Dubai - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Closet Design Sheikh Zayed Road Dubai - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Lighting design" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Professional design" },
  { src: "/dubai-luxury-interior-design-585x734.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Luxury spaces" },
  { src: "/Villa-interior-design-Sheikh Zayed Road Dubai-with-Accouter-Design.webp", alt: "Closet Design Sheikh Zayed Road Dubai - Premium interiors" },
  { src: "/meet.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Modern design" },
  { src: "/2b-scaled.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Custom design" },
  { src: "/DSC01457-min-scaled.webp", alt: "Closet Design Sheikh Zayed Road Dubai - Expert execution" },
  { src: "/98488683052973.5d304d1b15e83.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Quality finishes" },
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Sheikh Zayed Road Dubai-2.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Functional design" },
  { src: "/Al-Barari-Kitchen.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Premium fixtures" },
  { src: "/kitchen-aesthetic-harmony-modern-luxury-fusion-interior-design-dream-home-1-min.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Aesthetic design" },
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Sheikh Zayed Road Dubai.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Space planning" },
  { src: "/9f76af35953159a45c406d49cb9bc4d0.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Design excellence" },
  { src: "/Zen_PalmD1_07b-scaled-1.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Serene spaces" },
  { src: "/1-Unique-Bathroom-Projects.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Unique projects" },
  { src: "/8-Bathroom-Inspiration-By-Sheikh Zayed Road Dubai-Top-Interior-Designers.jpeg", alt: "Closet Design Sheikh Zayed Road Dubai - Design inspiration" },
  { src: "/Sheikh Zayed Road Dubai-Bathroom-Design-2.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Sheikh Zayed Road Dubai design" },
  { src: "/bathroom-1024x683.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Luxury bathroom" },
  { src: "/gf-ktchen-view2.jpg", alt: "Closet Design Sheikh Zayed Road Dubai - Kitchen design" },
  { src: "/10-Stunning-Kitchen-Island-Designs-to-Elevate-Your-Culinary-Space.jpeg", alt: "Closet Design Sheikh Zayed Road Dubai - Island designs" },
]

export default function ClosetDesignSheikhZayedRoad() {
  const [showAllImages, setShowAllImages] = useState(false)
  const whatsappNumber = "916353583148"
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Closet Design Sheikh Zayed Road Dubai services in Sheikh Zayed Road Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
              ...
              <div className="relative mb-8 hidden lg:block">
                <div className="aspect-[16/9] rounded-2xl overflow-hidden shadow-2xl">
                  <img 
                    ...
                    alt="Closet Design Sheikh Zayed Road Dubai by Interiara"
            ...
            <div className="lg:col-span-2 order-2 lg:order-none w-full">
              <ServicePageForm serviceName="Closet Design Sheikh Zayed Road Dubai" />
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 text-center">
              Why Choose Interiara for Closet Design Sheikh Zayed Road Dubai?
            </h2>
            
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              <p>
                At Interiara, we believe that exceptional <strong>Closet Design Sheikh Zayed Road Dubai</strong> creates spaces that inspire and delight. With over 15 years of experience in the Sheikh Zayed Road Dubai design industry, our team of 25+ expert designers understands the nuances of creating beautiful, functional spaces that exceed expectations.
              </p>

              <p>
                We've completed 300+ successful projects across Sheikh Zayed Road Dubai and the UAE, ranging from residential to commercial spaces. Our portfolio showcases our versatility in Closet Design Sheikh Zayed Road Dubai, from contemporary minimalist designs to luxurious traditional aesthetics. Whether you're looking for budget-friendly solutions or premium luxury finishes, Interiara delivers excellence at every level.
              </p>

              <h3 className="text-2xl font-bold text-foreground mt-12 mb-4">Our Closet Design Sheikh Zayed Road Dubai Approach</h3>
              ...
              <p>
                Our <strong>Closet Design Sheikh Zayed Road Dubai</strong> services include:
              </p>
              ...
              <p>
                Professional Closet Design Sheikh Zayed Road Dubai is an investment in your property's value and your quality of life. Well-designed spaces command higher property values, improve functionality, and create lasting impressions on clients and visitors.
              </p>

              <p>
                Whether you're renovating your home, opening a new business, or refreshing your existing space, Interiara is your trusted partner for exceptional <strong>Closet Design Sheikh Zayed Road Dubai</strong>. Contact us today for a free consultation and let's transform your space together.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Why Choose Our Closet Design Sheikh Zayed Road Dubai Services
            </h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Our Closet Design Sheikh Zayed Road Dubai Projects
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
