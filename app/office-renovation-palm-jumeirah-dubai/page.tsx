...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Renovation in Palm Jumeirah, Dubai",
    "url": "https://interiara.com/office-renovation-palm-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Renovation",
        "item": "https://interiara.com/office-renovation-palm-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Renovation in Palm Jumeirah, Dubai | Interiara",
  description: "Expert office renovation in Palm Jumeirah, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "office renovation",
    "office renovation Palm Jumeirah",
  ...
  canonical: "https://interiara.com/office-renovation-palm-jumeirah",
  twitter: {
