...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Restaurant Interior Design in Umm Suqeim, Dubai",
    "url": "https://interiara.com/restaurant-interior-design-umm-suqeim",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Restaurant Interior Design",
        "item": "https://interiara.com/restaurant-interior-design-umm-suqeim"
      }}
    ]
  }})} />

export const metadata = {
  title: "Restaurant Interior Design in Umm Suqeim, Dubai | Interiara",
  description: "Transform your space with premium restaurant interior design in Umm Suqeim. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "restaurant interior design",
    "restaurant interior design Umm Suqeim",
  ...
  canonical: "https://interiara.com/restaurant-interior-design-umm-suqeim",
  twitter: {
