...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wall Flooring Design in Al Quoz, Dubai",
    "url": "https://interiara.com/wall-flooring-design-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wall Flooring Design",
        "item": "https://interiara.com/wall-flooring-design-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wall Flooring Design in Al Quoz, Dubai | Interiara",
  description: "Expert wall flooring design in Al Quoz, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wall flooring design",
    "wall flooring design Al Quoz",
  ...
  canonical: "https://interiara.com/wall-flooring-design-al-quoz",
  twitter: {
