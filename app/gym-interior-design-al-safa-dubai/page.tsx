...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Gym Interior Design in Al Safa, Dubai",
    "url": "https://interiara.com/gym-interior-design-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Gym Interior Design",
        "item": "https://interiara.com/gym-interior-design-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Gym Interior Design in Al Safa, Dubai | Interiara",
  description: "Transform your space with premium gym interior design in Al Safa. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "gym interior design",
    "gym interior design Al Safa",
  ...
  canonical: "https://interiara.com/gym-interior-design-al-safa",
  twitter: {
