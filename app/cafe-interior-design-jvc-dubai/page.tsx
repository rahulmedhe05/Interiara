...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Cafe Interior Design in JVC, Dubai",
    "url": "https://interiara.com/cafe-interior-design-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Cafe Interior Design",
        "item": "https://interiara.com/cafe-interior-design-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Cafe Interior Design in JVC, Dubai | Interiara",
  description: "Transform your space with premium cafe interior design in JVC. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/cafe-interior-design-jvc",
  twitter: {
