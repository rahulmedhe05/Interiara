...
const galleryImages = [
  { src: "/dubai-interior-design-luxury.jpg", alt: "Wall Coverings Dubai Creek Dubai - Luxury design" },
  { src: "/Reception-9.jpg", alt: "Wall Coverings Dubai Creek Dubai - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Wall Coverings Dubai Creek Dubai - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Wall Coverings Dubai Creek Dubai - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Wall Coverings Dubai Creek Dubai - Lighting design" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Wall Coverings Dubai Creek Dubai - Professional design" },
  { src: "/dubai-luxury-interior-design-585x734.jpg", alt: "Wall Coverings Dubai Creek Dubai - Luxury spaces" },
  { src: "/Villa-interior-design-Dubai Creek Dubai-with-Accouter-Design.webp", alt: "Wall Coverings Dubai Creek Dubai - Premium interiors" },
  { src: "/meet.jpg", alt: "Wall Coverings Dubai Creek Dubai - Modern design" },
  { src: "/2b-scaled.jpg", alt: "Wall Coverings Dubai Creek Dubai - Custom design" },
  { src: "/DSC01457-min-scaled.webp", alt: "Wall Coverings Dubai Creek Dubai - Expert execution" },
  { src: "/98488683052973.5d304d1b15e83.jpg", alt: "Wall Coverings Dubai Creek Dubai - Quality finishes" },
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Dubai Creek Dubai-2.jpg", alt: "Wall Coverings Dubai Creek Dubai - Functional design" },
  { src: "/Al-Barari-Kitchen.jpg", alt: "Wall Coverings Dubai Creek Dubai - Premium fixtures" },
  { src: "/kitchen-aesthetic-harmony-modern-luxury-fusion-interior-design-dream-home-1-min.jpg", alt: "Wall Coverings Dubai Creek Dubai - Aesthetic design" },
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Dubai Creek Dubai.jpg", alt: "Wall Coverings Dubai Creek Dubai - Space planning" },
  { src: "/9f76af35953159a45c406d49cb9bc4d0.jpg", alt: "Wall Coverings Dubai Creek Dubai - Design excellence" },
  { src: "/Zen_PalmD1_07b-scaled-1.jpg", alt: "Wall Coverings Dubai Creek Dubai - Serene spaces" },
  { src: "/1-Unique-Bathroom-Projects.jpg", alt: "Wall Coverings Dubai Creek Dubai - Unique projects" },
  { src: "/8-Bathroom-Inspiration-By-Dubai Creek Dubai-Top-Interior-Designers.jpeg", alt: "Wall Coverings Dubai Creek Dubai - Design inspiration" },
  { src: "/Dubai Creek Dubai-Bathroom-Design-2.jpg", alt: "Wall Coverings Dubai Creek Dubai - Dubai Creek Dubai design" },
  { src: "/bathroom-1024x683.jpg", alt: "Wall Coverings Dubai Creek Dubai - Luxury bathroom" },
  { src: "/gf-ktchen-view2.jpg", alt: "Wall Coverings Dubai Creek Dubai - Kitchen design" },
  { src: "/10-Stunning-Kitchen-Island-Designs-to-Elevate-Your-Culinary-Space.jpeg", alt: "Wall Coverings Dubai Creek Dubai - Island designs" },
]

export default function WallCoveringsCreek() {
  const [showAllImages, setShowAllImages] = useState(false)
  const whatsappNumber = "916353583148"
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Wall Coverings Dubai Creek Dubai services in Dubai Creek Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best wall Coverings Creek Company Coverings Creek</p>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 leading-tight">
                Expert Wall Coverings Dubai Creek Dubai - <span className="text-primary">Transform Your Space</span>
              </h1>
              <p className="text-lg text-muted-foreground mb-6 lg:mb-8 leading-relaxed">
                Looking for professional <strong>Wall Coverings Dubai Creek Dubai</strong>? Interiara is Dubai Creek Dubai's premier <strong>Wall Coverings Dubai Creek Dubai company</strong>, specializing in creating beautiful, functional spaces. With 300+ projects completed and 15+ years of experience, we deliver exceptional results tailored to your needs.
              </p>
              ...
              <div className="relative mb-8 hidden lg:block">
                <div className="aspect-[16/9] rounded-2xl overflow-hidden shadow-2xl">
                  <img 
                    ...
                    alt="Wall Coverings Dubai Creek Dubai by Interiara"
            ...
            <div className="lg:col-span-2 order-2 lg:order-none w-full">
              <ServicePageForm serviceName="Wall Coverings Dubai Creek Dubai" />
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 text-center">
              Why Choose Interiara for Wall Coverings Dubai Creek Dubai?
            </h2>
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              ...
              <p>
                Our <strong>Wall Coverings Dubai Creek Dubai</strong> services include:
              </p>
              ...
              <p>
                Professional Wall Coverings Dubai Creek Dubai is an investment in your property's value and your quality of life. Well-designed spaces command higher property values, improve functionality, and create lasting impressions on clients and visitors.
              </p>

              <p>
                Whether you're renovating your home, opening a new business, or refreshing your existing space, Interiara is your trusted partner for exceptional <strong>Wall Coverings Dubai Creek Dubai</strong>. Contact us today for a free consultation and let's transform your space together.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Why Choose Our Wall Coverings Dubai Creek Dubai Services
            </h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Our Wall Coverings Dubai Creek Dubai Projects
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">
              All Coverings Creek Services
            </h2>
            <p className="text-muted-foreground mb-8">
              Explore our complete range of interior design services available in Coverings Creek. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-3">
              <Link href="/wall-coverings-creek-dubai" className="block text-primary hover:text-primary-dark hover:underline transition-colors duration-200 text-sm font-medium">
                Wall
              </Link>
            </div>
            <div className="space-y-3">
          ...
          <div className="mt-12 pt-8 border-t">
            <p className="text-center text-sm text-muted-foreground">
              Looking for a specific service in Coverings Creek? 
