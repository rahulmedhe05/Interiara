...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Eco Friendly Interior Design in City Walk, Dubai",
    "url": "https://interiara.com/eco-friendly-interior-design-city-walk",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Eco Friendly Interior Design",
        "item": "https://interiara.com/eco-friendly-interior-design-city-walk"
      }}
    ]
  }})} />

export const metadata = {
  title: "Eco Friendly Interior Design in City Walk, Dubai | Interiara",
  description: "Transform your space with premium eco friendly interior design in City Walk. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "eco friendly interior design",
    "eco friendly interior design City Walk",
  ...
  canonical: "https://interiara.com/eco-friendly-interior-design-city-walk",
  twitter: {
