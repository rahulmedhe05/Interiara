...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Gym Interior Design in JVC, Dubai",
    "url": "https://interiara.com/gym-interior-design-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Gym Interior Design",
        "item": "https://interiara.com/gym-interior-design-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Gym Interior Design in JVC, Dubai | Interiara",
  description: "Transform your space with premium gym interior design in JVC. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "gym interior design",
  ...
  canonical: "https://interiara.com/gym-interior-design-jvc",
  twitter: {
