...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Window Blinds in Palm Jumeirah, Dubai",
    "url": "https://interiara.com/window-blinds-palm-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Window Blinds",
        "item": "https://interiara.com/window-blinds-palm-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Window Blinds in Palm Jumeirah, Dubai | Interiara",
  description: "Expert window blinds in Palm Jumeirah, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "window blinds",
    "window blinds Palm Jumeirah",
  ...
  canonical: "https://interiara.com/window-blinds-palm-jumeirah",
  twitter: {
