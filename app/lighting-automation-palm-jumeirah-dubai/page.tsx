...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Lighting Automation in Palm Jumeirah, Dubai",
    "url": "https://interiara.com/lighting-automation-palm-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Lighting Automation",
        "item": "https://interiara.com/lighting-automation-palm-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Lighting Automation in Palm Jumeirah, Dubai | Interiara",
  description: "Expert lighting automation in Palm Jumeirah, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "lighting automation",
    "lighting automation Palm Jumeirah",
  ...
  canonical: "https://interiara.com/lighting-automation-palm-jumeirah",
  twitter: {
