        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Retail Shop Interior in Design Jvt. Best retail shop interior Design Jvt Company Design Jvt Our luxury retail shop interior design jvt services are designed for excellence.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              ...
              <p>Retail Shop Interior Design Jvt. 
              ...
              <p>
               ...
               Our retail shop interior in design jvt service ensures quality.</p>
              ...
              <p>
               ...
               Specializing in retail shop interior near design jvt.</p>
