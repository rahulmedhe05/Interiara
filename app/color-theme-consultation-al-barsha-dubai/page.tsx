...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Color Theme Consultation in Al Barsha, Dubai",
    "url": "https://interiara.com/color-theme-consultation-al-barsha",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Color Theme Consultation",
        "item": "https://interiara.com/color-theme-consultation-al-barsha"
      }}
    ]
  }})} />

export const metadata = {
  title: "Color Theme Consultation in Al Barsha, Dubai | Interiara",
  description: "Expert color theme consultation in Al Barsha, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "color theme consultation",
    "color theme consultation Al Barsha",
  ...
  canonical: "https://interiara.com/color-theme-consultation-al-barsha",
  twitter: {
