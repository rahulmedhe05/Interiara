  ...
  return (
    <main>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-bold mb-4">
              Smart Home Interior Design Downtown Dubai - Transform Your Space
            </h1>
            <p className="text-lg text-primary-foreground/90 mb-8">
              Premium smart home interior design downtown dubai solutions in Downtown Dubai. Expert design team creating stunning, functional spaces with attention to detail. 300+ projects completed • 15+ years experience • 98% client satisfaction
            </p>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8">Our Smart Home Interior Design Downtown Dubai Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {galleryImages.slice(0, showAllGallery ? 24 : 6).map((img, index) => (
              <div key={index} className="relative aspect-square bg-secondary/10 rounded-lg overflow-hidden">
                <Image
                  src={img}
                  alt={`Smart Home Interior Design Downtown Dubai Design ${index + 1}`}
                  fill
