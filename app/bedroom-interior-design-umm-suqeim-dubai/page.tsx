...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Bedroom Interior Design in Umm Suqeim, Dubai",
    "url": "https://interiara.com/bedroom-interior-design-umm-suqeim",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Bedroom Interior Design",
        "item": "https://interiara.com/bedroom-interior-design-umm-suqeim"
      }}
    ]
  }})} />

export const metadata = {
  title: "Bedroom Interior Design in Umm Suqeim, Dubai | Interiara",
  description: "Transform your space with premium bedroom interior design in Umm Suqeim. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "bedroom interior design",
    "bedroom interior design Umm Suqeim",
  ...
  canonical: "https://interiara.com/bedroom-interior-design-umm-suqeim",
  twitter: {
