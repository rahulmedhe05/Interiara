...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Acoustic Design in JBR, Dubai",
    "url": "https://interiara.com/acoustic-design-jbr",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Acoustic Design",
        "item": "https://interiara.com/acoustic-design-jbr"
      }}
    ]
  }})} />

export const metadata = {
  title: "Acoustic Design in JBR, Dubai | Interiara",
  description: "Expert acoustic design in JBR, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "acoustic design",
    "acoustic design JBR",
  ...
  canonical: "https://interiara.com/acoustic-design-jbr",
  twitter: {
