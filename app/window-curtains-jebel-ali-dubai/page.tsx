...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-Jebel Ali Dubai-with-Accouter-Design.webp", alt: "Window Curtains Jebel Ali Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Jebel Ali Dubai-2.jpg", alt: "Window Curtains Jebel Ali Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Jebel Ali Dubai.jpg", alt: "Window Curtains Jebel Ali Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-Jebel Ali Dubai-Top-Interior-Designers.jpeg", alt: "Window Curtains Jebel Ali Dubai - Design inspiration" },
  { src: "/Jebel Ali Dubai-Bathroom-Design-2.jpg", alt: "Window Curtains Jebel Ali Dubai - Jebel Ali Dubai design" },
...
export default function TerraceInteriorDesignJebel Ali Dubai() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Window Curtains Jebel Ali Dubai services in Jebel Ali Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best Window Curtains Jebel Ali Dubai Company Jebel Ali Dubai</p>
              ...
              <p className="text-lg text-muted-foreground mb-6 lg:mb-8 leading-relaxed">
                Looking for professional <strong>Window Curtains Jebel Ali Dubai</strong>? Interiara is Jebel Ali Dubai's premier <strong>Window Curtains Jebel Ali Dubai company</strong>, specializing in creating beautiful, functional spaces. With 300+ projects completed and 15+ years of experience, we deliver exceptional results tailored to your needs.
              </p>
