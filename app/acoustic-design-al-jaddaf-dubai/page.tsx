...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-Al Jaddaf Dubai-with-Accouter-Design.webp", alt: "Acoustic Design Al Jaddaf Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Al Jaddaf Dubai-2.jpg", alt: "Acoustic Design Al Jaddaf Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Al Jaddaf Dubai.jpg", alt: "Acoustic Design Al Jaddaf Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-Al Jaddaf Dubai-Top-Interior-Designers.jpeg", alt: "Acoustic Design Al Jaddaf Dubai - Design inspiration" },
  { src: "/Al Jaddaf Dubai-Bathroom-Design-2.jpg", alt: "Acoustic Design Al Jaddaf Dubai - Al Jaddaf Dubai design" },
...
export default function AcousticDesignAlJaddaf() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Acoustic Design Al Jaddaf Dubai services in Al Jaddaf Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best Acoustic Design Al Jaddaf Dubai Company Al Jaddaf Dubai</p>
