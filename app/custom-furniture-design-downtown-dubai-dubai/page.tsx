...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Custom Furniture Design in Downtown Dubai, Dubai",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Custom Furniture Design",
        "item": "https://interiara.com/custom-furniture-design-downtown-dubai"
      }}
    ]
  }})} />

export const metadata = {
  title: "Custom Furniture Design in Downtown Dubai, Dubai | Interiara",
  description: "Bespoke custom furniture design in Downtown Dubai. Handcrafted furniture tailored to your style. Premium quality. Get quote!",
  keywords: [
    "custom furniture design",
    "custom furniture design Downtown Dubai",
...
export default function CustomFurnitureDesignDowntownDubai() {
