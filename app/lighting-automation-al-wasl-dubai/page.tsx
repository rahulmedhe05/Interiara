...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Lighting Automation in Al Wasl, Dubai",
    "url": "https://interiara.com/lighting-automation-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Lighting Automation",
        "item": "https://interiara.com/lighting-automation-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Lighting Automation in Al Wasl, Dubai | Interiara",
  description: "Expert lighting automation in Al Wasl, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "lighting automation",
    "lighting automation Al Wasl",
  ...
  canonical: "https://interiara.com/lighting-automation-al-wasl",
  twitter: {
