...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Retail Shop Interior Design in City Walk, Dubai",
    "url": "https://interiara.com/retail-shop-interior-design-city-walk",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Retail Shop Interior Design",
        "item": "https://interiara.com/retail-shop-interior-design-city-walk"
      }}
    ]
  }})} />

export const metadata = {
  title: "Retail Shop Interior Design in City Walk, Dubai | Interiara",
  description: "Transform your space with premium retail shop interior design in City Walk. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "retail shop interior design",
    "retail shop interior design City Walk",
  ...
  canonical: "https://interiara.com/retail-shop-interior-design-city-walk",
  twitter: {
