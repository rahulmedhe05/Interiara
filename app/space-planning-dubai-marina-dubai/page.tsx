...
// SEO Keywords: Space Planning Dubai Marina, Space Planning Dubai Marina Dubai, best Space Planning in Dubai Marina, professional Space Planning Dubai Marina, expert Space Planning Dubai Marina Dubai, Space Planning services Dubai Marina, Space Planning company Dubai Marina, Space Planning specialist Dubai Marina
...
const galleryImages = [
  ...
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Space Planning Dubai Marina - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Space Planning Dubai Marina - Professional design" },
]

export const metadata = {
  title: "Space Planning in Dubai Marina Dubai | Expert Interior Design Services",
  ...
  keywords: "Space Planning Dubai Marina, Space Planning Dubai Marina Dubai, best Space Planning in Dubai Marina, professional Space Planning Dubai Marina, expert Space Planning Dubai Marina Dubai, Space Planning services Dubai Marina, Space Planning company Dubai Marina, Space Planning specialist Dubai Marina",
  openGraph: {
    title: "Space Planning in Dubai Marina Dubai",
    description: "Expert Space Planning services in Dubai Marina, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Space Planning in Dubai Marina",
      },
    ],
  },
  robots: "index, follow",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Space Planning services in Dubai Marina. Please share more details and pricing."
  )
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Space Planning in Dubai Marina?
...
Dubai Marina residents and businesses benefit from professional space planning that considers:
...
Our Dubai Marina team understands these unique factors, delivering space planning solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Space Planning in Dubai Marina?
...
Professional space planning in Dubai Marina offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert space planning can create your perfect Dubai Marina environment. Schedule your free consultation now.
          </p>
