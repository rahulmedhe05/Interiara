...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Design in Business Bay, Dubai",
    "url": "https://interiara.com/interior-design-business-bay",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Design",
        "item": "https://interiara.com/interior-design-business-bay"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Design in Business Bay, Dubai | Interiara",
  description: "Transform your space with premium interior design in Business Bay. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "interior design",
  ...
  canonical: "https://interiara.com/interior-design-business-bay",
  twitter: {
