        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Event Hall Interior in Design Jvc. Best event hall interior Design Jvc Company Design Jvc Our luxury event hall interior design jvc services are designed for excellence.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              ...
              <p>Event Hall Interior Design Jvc. 
              ...
              <p>
               ...
               Our event hall interior in design jvc service ensures quality.</p>
              ...
              <p>
               ...
               Specializing in event hall interior near design jvc.</p>
