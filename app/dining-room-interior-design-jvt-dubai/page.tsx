...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Dining Room Interior Design in JVT, Dubai",
    "url": "https://interiara.com/dining-room-interior-design-jvt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Dining Room Interior Design",
        "item": "https://interiara.com/dining-room-interior-design-jvt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Dining Room Interior Design in JVT, Dubai | Interiara",
  description: "Transform your space with premium dining room interior design in JVT. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "dining room interior design",
    "dining room interior design JVT",
  ...
  canonical: "https://interiara.com/dining-room-interior-design-jvt",
  twitter: {
