...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Commercial Interior Design in Al Barsha, Dubai",
    "url": "https://interiara.com/commercial-interior-design-al-barsha",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Commercial Interior Design",
        "item": "https://interiara.com/commercial-interior-design-al-barsha"
      }}
    ]
  }})} />

export const metadata = {
  title: "Commercial Interior Design in Al Barsha, Dubai | Interiara",
  description: "Transform your space with premium commercial interior design in Al Barsha. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "commercial interior design",
    "commercial interior design Al Barsha",
  ...
  canonical: "https://interiara.com/commercial-interior-design-al-barsha",
  twitter: {
