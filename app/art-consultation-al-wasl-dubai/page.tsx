...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Art Consultation in Al Wasl, Dubai",
    "url": "https://interiara.com/art-consultation-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Art Consultation",
        "item": "https://interiara.com/art-consultation-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Art Consultation in Al Wasl, Dubai | Interiara",
  description: "Expert art consultation in Al Wasl, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "art consultation",
    "art consultation Al Wasl",
  ...
  canonical: "https://interiara.com/art-consultation-al-wasl",
  twitter: {
