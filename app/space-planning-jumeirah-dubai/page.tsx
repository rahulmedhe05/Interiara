...
// SEO Keywords: Space Planning Jumeirah, Space Planning Jumeirah Dubai, best Space Planning in Jumeirah, professional Space Planning Jumeirah, expert Space Planning Jumeirah Dubai, Space Planning services Jumeirah, Space Planning company Jumeirah, Space Planning specialist Jumeirah
...
const galleryImages = [
  ...
  { src: "/Reception-9.jpg", alt: "Space Planning Jumeirah - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Space Planning Jumeirah - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Space Planning Jumeirah - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Space Planning Jumeirah - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Space Planning Jumeirah - Professional design" },
]

export const metadata = {
  title: "Space Planning in Jumeirah Dubai | Expert Interior Design Services",
  ...
  keywords: "Space Planning Jumeirah, Space Planning Jumeirah Dubai, best Space Planning in Jumeirah, professional Space Planning Jumeirah, expert Space Planning Jumeirah Dubai, Space Planning services Jumeirah, Space Planning company Jumeirah, Space Planning specialist Jumeirah",
  openGraph: {
    title: "Space Planning in Jumeirah Dubai",
    description: "Expert Space Planning services in Jumeirah, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Space Planning in Jumeirah",
      },
    ],
  },
  robots: "index, follow",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Space Planning services in Jumeirah. Please share more details and pricing."
  )
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Space Planning in Jumeirah?
...
Jumeirah residents and businesses benefit from professional space planning that considers:
...
Our Jumeirah team understands these unique factors, delivering space planning solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Space Planning in Jumeirah?
...
Professional space planning in Jumeirah offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert space planning can create your perfect Jumeirah environment. Schedule your free consultation now.
          </p>
