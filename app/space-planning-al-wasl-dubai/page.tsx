...
// SEO Keywords: Space Planning Al Wasl, Space Planning Al Wasl Dubai, best Space Planning in Al Wasl, professional Space Planning Al Wasl, expert Space Planning Al Wasl Dubai, Space Planning services Al Wasl, Space Planning company Al Wasl, Space Planning specialist Al Wasl
...
const galleryImages = [
  ...
  { src: "/Reception-9.jpg", alt: "Space Planning Al Wasl - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Space Planning Al Wasl - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Space Planning Al Wasl - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Space Planning Al Wasl - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Space Planning Al Wasl - Professional design" },
]

export const metadata = {
  title: "Space Planning in Al Wasl Dubai | Expert Interior Design Services",
  ...
  keywords: "Space Planning Al Wasl, Space Planning Al Wasl Dubai, best Space Planning in Al Wasl, professional Space Planning Al Wasl, expert Space Planning Al Wasl Dubai, Space Planning services Al Wasl, Space Planning company Al Wasl, Space Planning specialist Al Wasl",
  openGraph: {
    title: "Space Planning in Al Wasl Dubai",
    description: "Expert Space Planning services in Al Wasl, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Space Planning services in Al Wasl. Please share more details and pricing."
  )
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Space Planning in Al Wasl?
...
Al Wasl residents and businesses benefit from professional space planning that considers:
...
Our Al Wasl team understands these unique factors, delivering space planning solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Space Planning in Al Wasl?
...
Professional space planning in Al Wasl offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert space planning can create your perfect Al Wasl environment. Schedule your free consultation now.
          </p>
