...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Space Planning in Al Wasl, Dubai",
    "url": "https://interiara.com/space-planning-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Space Planning",
        "item": "https://interiara.com/space-planning-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Space Planning in Al Wasl, Dubai | Interiara",
  description: "Expert space planning in Al Wasl, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "space planning",
    "space planning Al Wasl",
  ...
  canonical: "https://interiara.com/space-planning-al-wasl",
  twitter: {
