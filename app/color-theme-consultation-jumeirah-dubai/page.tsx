...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Color Theme Consultation in Jumeirah, Dubai",
    "url": "https://interiara.com/color-theme-consultation-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Color Theme Consultation",
        "item": "https://interiara.com/color-theme-consultation-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Color Theme Consultation in Jumeirah, Dubai | Interiara",
  description: "Expert color theme consultation in Jumeirah, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "color theme consultation",
    "color theme consultation Jumeirah",
  ...
  canonical: "https://interiara.com/color-theme-consultation-jumeirah",
  twitter: {
