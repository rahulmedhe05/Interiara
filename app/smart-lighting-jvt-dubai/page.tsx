...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Smart Lighting in JVT, Dubai",
    "url": "https://interiara.com/smart-lighting-jvt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Smart Lighting",
        "item": "https://interiara.com/smart-lighting-jvt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Smart Lighting in JVT, Dubai | Interiara",
  description: "Expert smart lighting in JVT, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "smart lighting",
    "smart lighting JVT",
  ...
  canonical: "https://interiara.com/smart-lighting-jvt",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JVT Dubai-with-Accouter-Design.webp", alt: "Smart Lighting JVT Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JVT Dubai-2.jpg", alt: "Smart Lighting JVT Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JVT Dubai.jpg", alt: "Smart Lighting JVT Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JVT Dubai-Top-Interior-Designers.jpeg", alt: "Smart Lighting JVT Dubai - Design inspiration" },
  { src: "/JVT Dubai-Bathroom-Design-2.jpg", alt: "Smart Lighting JVT Dubai - JVT Dubai design" },
...
export default function SmartLightingJvt() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Smart Lighting JVT Dubai services in JVT Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best smart Lighting Jvt Company Lighting Jvt</p>
