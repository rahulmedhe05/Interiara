...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Lighting Automation in Al Quoz, Dubai",
    "url": "https://interiara.com/lighting-automation-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Lighting Automation",
        "item": "https://interiara.com/lighting-automation-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Lighting Automation in Al Quoz, Dubai | Interiara",
  description: "Expert lighting automation in Al Quoz, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "lighting automation",
    "lighting automation Al Quoz",
  ...
  canonical: "https://interiara.com/lighting-automation-al-quoz",
  twitter: {
