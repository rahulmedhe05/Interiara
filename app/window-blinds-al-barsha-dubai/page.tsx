...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Window Blinds in Al Barsha, Dubai",
    "url": "https://interiara.com/window-blinds-al-barsha",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Window Blinds",
        "item": "https://interiara.com/window-blinds-al-barsha"
      }}
    ]
  }})} />

export const metadata = {
  title: "Window Blinds in Al Barsha, Dubai | Interiara",
  description: "Expert window blinds in Al Barsha, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "window blinds",
    "window blinds Al Barsha",
  ...
  canonical: "https://interiara.com/window-blinds-al-barsha",
  twitter: {
