...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Villa Interior Design in Town Square, Dubai",
    "url": "https://interiara.com/villa-interior-design-town-square",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Villa Interior Design",
        "item": "https://interiara.com/villa-interior-design-town-square"
      }}
    ]
  }})} />

export const metadata = {
  title: "Villa Interior Design in Town Square, Dubai | Interiara",
  description: "Transform your space with premium villa interior design in Town Square. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "villa interior design",
    "villa interior design Town Square",
  ...
  canonical: "https://interiara.com/villa-interior-design-town-square",
  twitter: {
