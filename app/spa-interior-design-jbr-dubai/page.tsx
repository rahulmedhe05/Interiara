...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Spa Interior Design in JBR, Dubai",
    "url": "https://interiara.com/spa-interior-design-jbr",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Spa Interior Design",
        "item": "https://interiara.com/spa-interior-design-jbr"
      }}
    ]
  }})} />

export const metadata = {
  title: "Spa Interior Design in JBR, Dubai | Interiara",
  description: "Transform your space with premium spa interior design in JBR. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "spa interior design",
    "spa interior design JBR",
  ...
  canonical: "https://interiara.com/spa-interior-design-jbr",
  twitter: {
