...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Fit Out in Mirdif, Dubai",
    "url": "https://interiara.com/office-fit-out-mirdif",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Fit Out",
        "item": "https://interiara.com/office-fit-out-mirdif"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Fit Out in Mirdif, Dubai | Interiara",
  description: "Complete office fit out services in Mirdif. Professional execution & quality assurance. Fast turnaround. Consult now!",
  keywords: [
    "office fit out",
    "office fit out Mirdif",
  ...
  canonical: "https://interiara.com/office-fit-out-mirdif",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-Mirdif Dubai-with-Accouter-Design.webp", alt: "Office Fit Out Mirdif Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Mirdif Dubai-2.jpg", alt: "Office Fit Out Mirdif Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Mirdif Dubai.jpg", alt: "Office Fit Out Mirdif Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-Mirdif Dubai-Top-Interior-Designers.jpeg", alt: "Office Fit Out Mirdif Dubai - Design inspiration" },
  { src: "/Mirdif Dubai-Bathroom-Design-2.jpg", alt: "Office Fit Out Mirdif Dubai - Mirdif Dubai design" },
...
export default function OfficeFitOutMirdif() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Office Fit Out Mirdif Dubai services in Mirdif Dubai. Please share more details.")
