...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Interior Design in Jumeirah, Dubai",
    "url": "https://interiara.com/office-interior-design-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Interior Design",
        "item": "https://interiara.com/office-interior-design-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Interior Design in Jumeirah, Dubai | Interiara",
  description: "Transform your space with premium office interior design in Jumeirah. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/office-interior-design-jumeirah",
  twitter: {
