...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Window Blinds in JVT, Dubai",
    "url": "https://interiara.com/window-blinds-jvt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Window Blinds",
        "item": "https://interiara.com/window-blinds-jvt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Window Blinds in JVT, Dubai | Interiara",
  description: "Expert window blinds in JVT, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "window blinds",
    "window blinds JVT",
  ...
  canonical: "https://interiara.com/window-blinds-jvt",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JVT Dubai-with-Accouter-Design.webp", alt: "Window Blinds JVT Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JVT Dubai-2.jpg", alt: "Window Blinds JVT Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JVT Dubai.jpg", alt: "Window Blinds JVT Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JVT Dubai-Top-Interior-Designers.jpeg", alt: "Window Blinds JVT Dubai - Design inspiration" },
  { src: "/JVT Dubai-Bathroom-Design-2.jpg", alt: "Window Blinds JVT Dubai - JVT Dubai design" },
...
export default function WindowBlindsJvt() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Window Blinds JVT Dubai services in JVT Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best window Blinds Jvt Company Blinds Jvt</p>
