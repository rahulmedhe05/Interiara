...
export const metadata: Metadata = {
  title: "Bespoke Furniture Design Downtown Dubai | Premium Design Services Downtown Dubai | Interiara",
  description: "Professional bespoke furniture design downtown dubai services in Downtown Dubai. Transform your space with our expert design team. Contact us for a free consultation and custom design proposal.",
  keywords: [
    "bespoke-furniture-design-downtown-dubai", "bespoke furniture design downtown dubai", "bespoke furniture design downtown dubai services", "best bespoke furniture design downtown dubai", "professional bespoke furniture design downtown dubai", "bespoke furniture design downtown dubai company downtown dubai", "bespoke furniture design downtown dubai specialist", "expert bespoke furniture design downtown dubai",
  ],
  openGraph: {
