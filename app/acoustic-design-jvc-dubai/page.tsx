...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Acoustic Design in JVC, Dubai",
    "url": "https://interiara.com/acoustic-design-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Acoustic Design",
        "item": "https://interiara.com/acoustic-design-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Acoustic Design in JVC, Dubai | Interiara",
  description: "Expert acoustic design in JVC, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "acoustic design",
    "acoustic design JVC",
  ...
  canonical: "https://interiara.com/acoustic-design-jvc",
  twitter: {
