...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Bedroom Interior Design in Arabian Ranches, Dubai",
    "url": "https://interiara.com/bedroom-interior-design-arabian-ranches",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Bedroom Interior Design",
        "item": "https://interiara.com/bedroom-interior-design-arabian-ranches"
      }}
    ]
  }})} />

export const metadata = {
  title: "Bedroom Interior Design in Arabian Ranches, Dubai | Interiara",
  description: "Transform your space with premium bedroom interior design in Arabian Ranches. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "bedroom interior design",
    "bedroom interior design Arabian Ranches",
  ...
  canonical: "https://interiara.com/bedroom-interior-design-arabian-ranches",
  twitter: {
