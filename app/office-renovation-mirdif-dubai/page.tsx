...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Renovation in Mirdif, Dubai",
    "url": "https://interiara.com/office-renovation-mirdif",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Renovation",
        "item": "https://interiara.com/office-renovation-mirdif"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Renovation in Mirdif, Dubai | Interiara",
  description: "Expert office renovation in Mirdif, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "office renovation",
    "office renovation Mirdif",
  ...
  canonical: "https://interiara.com/office-renovation-mirdif",
  twitter: {
