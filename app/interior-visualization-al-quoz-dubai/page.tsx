...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Visualization in Al Quoz, Dubai",
    "url": "https://interiara.com/interior-visualization-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Visualization",
        "item": "https://interiara.com/interior-visualization-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Visualization in Al Quoz, Dubai | Interiara",
  description: "Expert interior visualization in Al Quoz, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "interior visualization",
    "interior visualization Al Quoz",
  ...
  canonical: "https://interiara.com/interior-visualization-al-quoz",
  twitter: {
