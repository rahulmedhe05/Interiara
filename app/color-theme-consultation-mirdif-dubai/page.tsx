...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Color Theme Consultation in Mirdif, Dubai",
    "url": "https://interiara.com/color-theme-consultation-mirdif",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Color Theme Consultation",
        "item": "https://interiara.com/color-theme-consultation-mirdif"
      }}
    ]
  }})} />

export const metadata = {
  title: "Color Theme Consultation in Mirdif, Dubai | Interiara",
  description: "Expert color theme consultation in Mirdif, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "color theme consultation",
    "color theme consultation Mirdif",
  ...
  canonical: "https://interiara.com/color-theme-consultation-mirdif",
  twitter: {
