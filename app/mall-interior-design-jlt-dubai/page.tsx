...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Mall Interior Design in JLT, Dubai",
    "url": "https://interiara.com/mall-interior-design-jlt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Mall Interior Design",
        "item": "https://interiara.com/mall-interior-design-jlt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Mall Interior Design in JLT, Dubai | Interiara",
  description: "Transform your space with premium mall interior design in JLT. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/mall-interior-design-jlt",
  twitter: {
