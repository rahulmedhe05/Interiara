...
// SEO Keywords: Lighting Design JBR, Lighting Design JBR Dubai, best Lighting Design in JBR, professional Lighting Design JBR, expert Lighting Design JBR Dubai, Lighting Design services JBR, Lighting Design company JBR, Lighting Design specialist JBR
...
const galleryImages = [
  ...
  { src: "/Reception-9.jpg", alt: "Lighting Design JBR - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Lighting Design JBR - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Lighting Design JBR - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Lighting Design JBR - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Lighting Design JBR - Professional design" },
]

export const metadata = {
  title: "Lighting Design in JBR Dubai | Expert Interior Design Services",
  ...
  keywords: "Lighting Design JBR, Lighting Design JBR Dubai, best Lighting Design in JBR, professional Lighting Design JBR, expert Lighting Design JBR Dubai, Lighting Design services JBR, Lighting Design company JBR, Lighting Design specialist JBR",
  openGraph: {
    title: "Lighting Design in JBR Dubai",
    description: "Expert Lighting Design services in JBR, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Lighting Design services in JBR. Please share more details and pricing."
  )
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed whitespace-pre-line">
                Transform your JBR space with expert lighting design services that create perfect ambiance and functionality. We design layered lighting solutions for residential and commercial spaces. Our JBR lighting expertise creates stunning visual environments.
              </p>
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Lighting Design in JBR?

Our lighting design services create perfect illumination for any space. We design JBR lighting solutions that enhance aesthetics while ensuring functional, energy-efficient lighting.
...
JBR residents and businesses benefit from professional lighting design that considers:
...
Our JBR team understands these unique factors, delivering lighting design solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Lighting Design in JBR?
...
Professional lighting design in JBR offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert lighting design can create your perfect JBR environment. Schedule your free consultation now.
          </p>
