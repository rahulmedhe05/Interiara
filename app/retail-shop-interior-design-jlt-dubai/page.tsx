...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Retail Shop Interior Design in JLT, Dubai",
    "url": "https://interiara.com/retail-shop-interior-design-jlt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Retail Shop Interior Design",
        "item": "https://interiara.com/retail-shop-interior-design-jlt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Retail Shop Interior Design in JLT, Dubai | Interiara",
  description: "Transform your space with premium retail shop interior design in JLT. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/retail-shop-interior-design-jlt",
  twitter: {
