...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Contemporary Interior Design in Al Furjan, Dubai",
    "url": "https://interiara.com/contemporary-interior-design-al-furjan",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Contemporary Interior Design",
        "item": "https://interiara.com/contemporary-interior-design-al-furjan"
      }}
    ]
  }})} />

export const metadata = {
  title: "Contemporary Interior Design in Al Furjan, Dubai | Interiara",
  description: "Transform your space with premium contemporary interior design in Al Furjan. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "contemporary interior design",
    "contemporary interior design Al Furjan",
  ...
  canonical: "https://interiara.com/contemporary-interior-design-al-furjan",
  twitter: {
