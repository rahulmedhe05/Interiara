...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Hotel Interior Design in JVC, Dubai",
    "url": "https://interiara.com/hotel-interior-design-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Hotel Interior Design",
        "item": "https://interiara.com/hotel-interior-design-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Hotel Interior Design in JVC, Dubai | Interiara",
  description: "Transform your space with premium hotel interior design in JVC. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "hotel interior design",
    "hotel interior design JVC",
  ...
  canonical: "https://interiara.com/hotel-interior-design-jvc",
  twitter: {
