...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Art Consultation in Mirdif, Dubai",
    "url": "https://interiara.com/art-consultation-mirdif",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Art Consultation",
        "item": "https://interiara.com/art-consultation-mirdif"
      }}
    ]
  }})} />

export const metadata = {
  title: "Art Consultation in Mirdif, Dubai | Interiara",
  description: "Expert art consultation in Mirdif, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "art consultation",
    "art consultation Mirdif",
  ...
  canonical: "https://interiara.com/art-consultation-mirdif",
  twitter: {
