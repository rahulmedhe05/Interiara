...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Window Blinds in Arabian Ranches, Dubai",
    "url": "https://interiara.com/window-blinds-arabian-ranches",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Window Blinds",
        "item": "https://interiara.com/window-blinds-arabian-ranches"
      }}
    ]
  }})} />

export const metadata = {
  title: "Window Blinds in Arabian Ranches, Dubai | Interiara",
  description: "Expert window blinds in Arabian Ranches, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "window blinds",
    "window blinds Arabian Ranches",
  ...
  canonical: "https://interiara.com/window-blinds-arabian-ranches",
  twitter: {
