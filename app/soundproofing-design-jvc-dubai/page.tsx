...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Soundproofing Design in JVC, Dubai",
    "url": "https://interiara.com/soundproofing-design-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Soundproofing Design",
        "item": "https://interiara.com/soundproofing-design-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Soundproofing Design in JVC, Dubai | Interiara",
  description: "Expert soundproofing design in JVC, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
  ...
  canonical: "https://interiara.com/soundproofing-design-jvc",
  twitter: {
