...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Smart Lighting in JBR, Dubai",
    "url": "https://interiara.com/smart-lighting-jbr",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Smart Lighting",
        "item": "https://interiara.com/smart-lighting-jbr"
      }}
    ]
  }})} />

export const metadata = {
  title: "Smart Lighting in JBR, Dubai | Interiara",
  description: "Expert smart lighting in JBR, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "smart lighting",
    "smart lighting JBR",
  ...
  canonical: "https://interiara.com/smart-lighting-jbr",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JBR Dubai-with-Accouter-Design.webp", alt: "Smart Lighting JBR Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JBR Dubai-2.jpg", alt: "Smart Lighting JBR Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JBR Dubai.jpg", alt: "Smart Lighting JBR Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JBR Dubai-Top-Interior-Designers.jpeg", alt: "Smart Lighting JBR Dubai - Design inspiration" },
  { src: "/JBR Dubai-Bathroom-Design-2.jpg", alt: "Smart Lighting JBR Dubai - JBR Dubai design" },
...
export default function SmartLightingJbr() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Smart Lighting JBR Dubai services in JBR Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best smart Lighting Jbr Company Lighting Jbr</p>
