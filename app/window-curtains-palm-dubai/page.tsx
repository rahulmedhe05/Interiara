...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-Palm Jumeirah Dubai-with-Accouter-Design.webp", alt: "Window Curtains Palm Jumeirah Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Palm Jumeirah Dubai-2.jpg", alt: "Window Curtains Palm Jumeirah Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Palm Jumeirah Dubai.jpg", alt: "Window Curtains Palm Jumeirah Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-Palm Jumeirah Dubai-Top-Interior-Designers.jpeg", alt: "Window Curtains Palm Jumeirah Dubai - Design inspiration" },
  { src: "/Palm Jumeirah Dubai-Bathroom-Design-2.jpg", alt: "Window Curtains Palm Jumeirah Dubai - Palm Jumeirah Dubai design" },
...
export default function WindowCurtainsPalm() {
  const [showAllImages, setShowAllImages] = useState(false)
  const whatsappNumber = "916353583148"
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Window Curtains Palm Jumeirah Dubai services in Palm Jumeirah Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best window Curtains Palm Company Curtains Palm</p>
              ...
              <p className="text-lg text-muted-foreground mb-6 lg:mb-8 leading-relaxed">
                Looking for professional <strong>Window Curtains Palm Jumeirah Dubai</strong>? Interiara is Palm Jumeirah Dubai's premier <strong>Window Curtains Palm Jumeirah Dubai company</strong>, specializing in creating beautiful, functional spaces. With 300+ projects completed and 15+ years of experience, we deliver exceptional results tailored to your needs.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">
              All Curtains Palm Services
            </h2>
            <p className="text-muted-foreground mb-8">
              Explore our complete range of interior design services available in Curtains Palm. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-3">
              <Link href="/window-curtains-palm-dubai" className="block text-primary hover:text-primary-dark hover:underline transition-colors duration-200 text-sm font-medium">
                Window
              </Link>
            </div>
            <div className="space-y-3">
          ...
          <div className="mt-12 pt-8 border-t">
            <p className="text-center text-sm text-muted-foreground">
              Looking for a specific service in Curtains Palm? 
