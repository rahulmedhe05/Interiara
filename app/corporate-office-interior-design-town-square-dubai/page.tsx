...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Corporate Office Interior Design in Town Square, Dubai",
    "url": "https://interiara.com/corporate-office-interior-design-town-square",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Corporate Office Interior Design",
        "item": "https://interiara.com/corporate-office-interior-design-town-square"
      }}
    ]
  }})} />

export const metadata = {
  title: "Corporate Office Interior Design in Town Square, Dubai | Interiara",
  description: "Transform your space with premium corporate office interior design in Town Square. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "corporate office interior design",
    "corporate office interior design Town Square",
  ...
  canonical: "https://interiara.com/corporate-office-interior-design-town-square",
  twitter: {
