...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Soundproofing Design in Jumeirah, Dubai",
    "url": "https://interiara.com/soundproofing-design-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Soundproofing Design",
        "item": "https://interiara.com/soundproofing-design-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Soundproofing Design in Jumeirah, Dubai | Interiara",
  description: "Expert soundproofing design in Jumeirah, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "soundproofing design",
    "soundproofing design Jumeirah",
  ...
  canonical: "https://interiara.com/soundproofing-design-jumeirah",
  twitter: {
