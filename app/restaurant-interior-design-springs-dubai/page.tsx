...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Restaurant Interior Design in Springs, Dubai",
    "url": "https://interiara.com/restaurant-interior-design-springs",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Restaurant Interior Design",
        "item": "https://interiara.com/restaurant-interior-design-springs"
      }}
    ]
  }})} />

export const metadata = {
  title: "Restaurant Interior Design in Springs, Dubai | Interiara",
  description: "Transform your space with premium restaurant interior design in Springs. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "restaurant interior design",
    "restaurant interior design Springs",
  ...
  canonical: "https://interiara.com/restaurant-interior-design-springs",
  twitter: {
