...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Event Hall Interior Design in The Villa, Dubai",
    "url": "https://interiara.com/event-hall-interior-design-the-villa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Event Hall Interior Design",
        "item": "https://interiara.com/event-hall-interior-design-the-villa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Event Hall Interior Design in The Villa, Dubai | Interiara",
  description: "Transform your space with premium event hall interior design in The Villa. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/event-hall-interior-design-the-villa",
  twitter: {
