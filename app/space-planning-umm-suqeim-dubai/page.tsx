...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Space Planning in Umm Suqeim, Dubai",
    "url": "https://interiara.com/space-planning-umm-suqeim",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Space Planning",
        "item": "https://interiara.com/space-planning-umm-suqeim"
      }}
    ]
  }})} />

export const metadata = {
  title: "Space Planning in Umm Suqeim, Dubai | Interiara",
  description: "Expert space planning in Umm Suqeim, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "space planning",
    "space planning Umm Suqeim",
  ...
  canonical: "https://interiara.com/space-planning-umm-suqeim",
  twitter: {
