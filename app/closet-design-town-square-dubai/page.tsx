...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Closet Design in Town Square, Dubai",
    "url": "https://interiara.com/closet-design-town-square",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Closet Design",
        "item": "https://interiara.com/closet-design-town-square"
      }}
    ]
  }})} />

export const metadata = {
  title: "Closet Design in Town Square, Dubai | Interiara",
  description: "Expert closet design in Town Square, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "closet design",
    "closet design Town Square",
  ...
  canonical: "https://interiara.com/closet-design-town-square",
  twitter: {
