...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Closet Design in Al Quoz, Dubai",
    "url": "https://interiara.com/closet-design-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Closet Design",
        "item": "https://interiara.com/closet-design-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Closet Design in Al Quoz, Dubai | Interiara",
  description: "Expert closet design in Al Quoz, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "closet design",
    "closet design Al Quoz",
  ...
  canonical: "https://interiara.com/closet-design-al-quoz",
  twitter: {
