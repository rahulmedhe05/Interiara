...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Closet Design in Al Furjan, Dubai",
    "url": "https://interiara.com/closet-design-al-furjan",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Closet Design",
        "item": "https://interiara.com/closet-design-al-furjan"
      }}
    ]
  }})} />

export const metadata = {
  title: "Closet Design in Al Furjan, Dubai | Interiara",
  description: "Expert closet design in Al Furjan, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "closet design",
    "closet design Al Furjan",
  ...
  canonical: "https://interiara.com/closet-design-al-furjan",
  twitter: {
