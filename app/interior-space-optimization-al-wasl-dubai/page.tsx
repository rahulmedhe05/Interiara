...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Space Optimization in Al Wasl, Dubai",
    "url": "https://interiara.com/interior-space-optimization-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Space Optimization",
        "item": "https://interiara.com/interior-space-optimization-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Space Optimization in Al Wasl, Dubai | Interiara",
  description: "Expert interior space optimization in Al Wasl, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "interior space optimization",
    "interior space optimization Al Wasl",
  ...
  canonical: "https://interiara.com/interior-space-optimization-al-wasl",
  twitter: {
