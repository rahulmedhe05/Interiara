...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Space Planning in City Walk, Dubai",
    "url": "https://interiara.com/space-planning-city-walk",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Space Planning",
        "item": "https://interiara.com/space-planning-city-walk"
      }}
    ]
  }})} />

export const metadata = {
  title: "Space Planning in City Walk, Dubai | Interiara",
  description: "Expert space planning in City Walk, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "space planning",
    "space planning City Walk",
  ...
  canonical: "https://interiara.com/space-planning-city-walk",
  twitter: {
