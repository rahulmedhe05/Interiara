...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Spa Interior Design in Al Safa, Dubai",
    "url": "https://interiara.com/spa-interior-design-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Spa Interior Design",
        "item": "https://interiara.com/spa-interior-design-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Spa Interior Design in Al Safa, Dubai | Interiara",
  description: "Transform your space with premium spa interior design in Al Safa. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "spa interior design",
    "spa interior design Al Safa",
  ...
  canonical: "https://interiara.com/spa-interior-design-al-safa",
  twitter: {
