...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Window Curtains in JVC, Dubai",
    "url": "https://interiara.com/window-curtains-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Window Curtains",
        "item": "https://interiara.com/window-curtains-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Window Curtains in JVC, Dubai | Interiara",
  description: "Expert window curtains in JVC, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "window curtains",
    "window curtains JVC",
  ...
  canonical: "https://interiara.com/window-curtains-jvc",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JVC Dubai-with-Accouter-Design.webp", alt: "Window Curtains JVC Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JVC Dubai-2.jpg", alt: "Window Curtains JVC Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JVC Dubai.jpg", alt: "Window Curtains JVC Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JVC Dubai-Top-Interior-Designers.jpeg", alt: "Window Curtains JVC Dubai - Design inspiration" },
  { src: "/JVC Dubai-Bathroom-Design-2.jpg", alt: "Window Curtains JVC Dubai - JVC Dubai design" },
...
export default function WindowCurtainsJvc() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Window Curtains JVC Dubai services in JVC Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best window Curtains Jvc Company Curtains Jvc</p>
