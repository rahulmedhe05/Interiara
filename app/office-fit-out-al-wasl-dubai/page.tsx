...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Fit Out in Al Wasl, Dubai",
    "url": "https://interiara.com/office-fit-out-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Fit Out",
        "item": "https://interiara.com/office-fit-out-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Fit Out in Al Wasl, Dubai | Interiara",
  description: "Complete office fit out services in Al Wasl. Professional execution & quality assurance. Fast turnaround. Consult now!",
  keywords: [
    "office fit out",
    "office fit out Al Wasl",
  ...
  canonical: "https://interiara.com/office-fit-out-al-wasl",
  twitter: {
