...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Hotel Interior Design in JBR, Dubai",
    "url": "https://interiara.com/hotel-interior-design-jbr",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Hotel Interior Design",
        "item": "https://interiara.com/hotel-interior-design-jbr"
      }}
    ]
  }})} />

export const metadata = {
  title: "Hotel Interior Design in JBR, Dubai | Interiara",
  description: "Transform your space with premium hotel interior design in JBR. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "hotel interior design",
    "hotel interior design JBR",
  ...
  canonical: "https://interiara.com/hotel-interior-design-jbr",
  twitter: {
