...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Cafe Interior Design in Al Furjan, Dubai",
    "url": "https://interiara.com/cafe-interior-design-al-furjan",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Cafe Interior Design",
        "item": "https://interiara.com/cafe-interior-design-al-furjan"
      }}
    ]
  }})} />

export const metadata = {
  title: "Cafe Interior Design in Al Furjan, Dubai | Interiara",
  description: "Transform your space with premium cafe interior design in Al Furjan. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "cafe interior design",
    "cafe interior design Al Furjan",
  ...
  canonical: "https://interiara.com/cafe-interior-design-al-furjan",
  twitter: {
