...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Bedroom Interior Design in Al Wasl, Dubai",
    "url": "https://interiara.com/bedroom-interior-design-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Bedroom Interior Design",
        "item": "https://interiara.com/bedroom-interior-design-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Bedroom Interior Design in Al Wasl, Dubai | Interiara",
  description: "Transform your space with premium bedroom interior design in Al Wasl. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "bedroom interior design",
    "bedroom interior design Al Wasl",
  ...
  canonical: "https://interiara.com/bedroom-interior-design-al-wasl",
  twitter: {
