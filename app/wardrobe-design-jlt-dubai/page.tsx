...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wardrobe Design in JLT, Dubai",
    "url": "https://interiara.com/wardrobe-design-jlt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wardrobe Design",
        "item": "https://interiara.com/wardrobe-design-jlt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wardrobe Design in JLT, Dubai | Interiara",
  description: "Custom wardrobe design in JLT. Bespoke wardrobes designed for your space. Professional installation. Consult now!",
  keywords: [
    "wardrobe design",
    "wardrobe design JLT",
  ...
  canonical: "https://interiara.com/wardrobe-design-jlt",
  twitter: {
