...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Design in JVT, Dubai",
    "url": "https://interiara.com/interior-design-jvt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Design",
        "item": "https://interiara.com/interior-design-jvt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Design in JVT, Dubai | Interiara",
  description: "Transform your space with premium interior design in JVT. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "interior design",
    "interior design JVT",
  ...
  canonical: "https://interiara.com/interior-design-jvt",
  twitter: {
