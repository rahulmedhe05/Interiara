...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Fitness Studio Interior Design in Springs, Dubai",
    "url": "https://interiara.com/fitness-studio-interior-design-springs",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Fitness Studio Interior Design",
        "item": "https://interiara.com/fitness-studio-interior-design-springs"
      }}
    ]
  }})} />

export const metadata = {
  title: "Fitness Studio Interior Design in Springs, Dubai | Interiara",
  description: "Transform your space with premium fitness studio interior design in Springs. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "fitness studio interior design",
    "fitness studio interior design Springs",
  ...
  canonical: "https://interiara.com/fitness-studio-interior-design-springs",
  twitter: {
