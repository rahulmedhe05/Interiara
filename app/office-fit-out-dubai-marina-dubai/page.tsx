...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Fit Out in Dubai Marina, Dubai",
    "url": "https://interiara.com/office-fit-out-dubai-marina",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Fit Out",
        "item": "https://interiara.com/office-fit-out-dubai-marina"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Fit Out in Dubai Marina, Dubai | Interiara",
  description: "Complete office fit out services in Dubai Marina. Professional execution & quality assurance. Fast turnaround. Consult now!",
  keywords: [
    "office fit out",
  ...
  canonical: "https://interiara.com/office-fit-out-dubai-marina",
  twitter: {
