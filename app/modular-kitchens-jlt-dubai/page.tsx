...
const galleryImages = [
  { src: "/dubai-interior-design-luxury.jpg", alt: "Modular Kitchens JLT Dubai - Luxury design" },
  { src: "/Reception-9.jpg", alt: "Modular Kitchens JLT Dubai - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Modular Kitchens JLT Dubai - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Modular Kitchens JLT Dubai - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Modular Kitchens JLT Dubai - Lighting design" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Modular Kitchens JLT Dubai - Professional design" },
  { src: "/dubai-luxury-interior-design-585x734.jpg", alt: "Modular Kitchens JLT Dubai - Luxury spaces" },
  { src: "/Villa-interior-design-JLT Dubai-with-Accouter-Design.webp", alt: "Modular Kitchens JLT Dubai - Premium interiors" },
  { src: "/meet.jpg", alt: "Modular Kitchens JLT Dubai - Modern design" },
  { src: "/2b-scaled.jpg", alt: "Modular Kitchens JLT Dubai - Custom design" },
  { src: "/DSC01457-min-scaled.webp", alt: "Modular Kitchens JLT Dubai - Expert execution" },
  { src: "/98488683052973.5d304d1b15e83.jpg", alt: "Modular Kitchens JLT Dubai - Quality finishes" },
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JLT Dubai-2.jpg", alt: "Modular Kitchens JLT Dubai - Functional design" },
  { src: "/Al-Barari-Kitchen.jpg", alt: "Modular Kitchens JLT Dubai - Premium fixtures" },
  { src: "/kitchen-aesthetic-harmony-modern-luxury-fusion-interior-design-dream-home-1-min.jpg", alt: "Modular Kitchens JLT Dubai - Aesthetic design" },
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JLT Dubai.jpg", alt: "Modular Kitchens JLT Dubai - Space planning" },
  { src: "/9f76af35953159a45c406d49cb9bc4d0.jpg", alt: "Modular Kitchens JLT Dubai - Design excellence" },
  { src: "/Zen_PalmD1_07b-scaled-1.jpg", alt: "Modular Kitchens JLT Dubai - Serene spaces" },
  { src: "/1-Unique-Bathroom-Projects.jpg", alt: "Modular Kitchens JLT Dubai - Unique projects" },
  { src: "/8-Bathroom-Inspiration-By-JLT Dubai-Top-Interior-Designers.jpeg", alt: "Modular Kitchens JLT Dubai - Design inspiration" },
  { src: "/JLT Dubai-Bathroom-Design-2.jpg", alt: "Modular Kitchens JLT Dubai - JLT Dubai design" },
  { src: "/bathroom-1024x683.jpg", alt: "Modular Kitchens JLT Dubai - Luxury bathroom" },
  { src: "/gf-ktchen-view2.jpg", alt: "Modular Kitchens JLT Dubai - Kitchen design" },
  { src: "/10-Stunning-Kitchen-Island-Designs-to-Elevate-Your-Culinary-Space.jpeg", alt: "Modular Kitchens JLT Dubai - Island designs" },
]

export default function ModularKitchensJlt() {
  const [showAllImages, setShowAllImages] = useState(false)
  const whatsappNumber = "916353583148"
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Modular Kitchens JLT Dubai services in JLT Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
              ...
              <div className="relative mb-8 hidden lg:block">
                <div className="aspect-[16/9] rounded-2xl overflow-hidden shadow-2xl">
                  <img 
                    ...
                    alt="Modular Kitchens JLT Dubai by Interiara"
            ...
            <div className="lg:col-span-2 order-2 lg:order-none w-full">
              <ServicePageForm serviceName="Modular Kitchens JLT Dubai" />
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 text-center">
              Why Choose Interiara for Modular Kitchens JLT Dubai?
            </h2>
            
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              <p>
                At Interiara, we believe that exceptional <strong>Modular Kitchens JLT Dubai</strong> creates spaces that inspire and delight. With over 15 years of experience in the JLT Dubai design industry, our team of 25+ expert designers understands the nuances of creating beautiful, functional spaces that exceed expectations.
              </p>

              <p>Modular in Kitchens Jlt. Modular Kitchens Jlt. 
                We've completed 300+ successful projects across JLT Dubai and the UAE, ranging from residential to commercial spaces. Our portfolio showcases our versatility in Modular Kitchens JLT Dubai, from contemporary minimalist designs to luxurious traditional aesthetics. Whether you're looking for budget-friendly solutions or premium luxury finishes, Interiara delivers excellence at every level.
               Our luxury modular kitchens jlt services are designed for excellence.</p>

              <h3 className="text-2xl font-bold text-foreground mt-12 mb-4">Our Modular Kitchens JLT Dubai Approach</h3>
              ...
              <p>
                Our <strong>Modular Kitchens JLT Dubai</strong> services include:
              </p>
              ...
              <p>
               ...
               Our modular in kitchens jlt service ensures quality.</p>

              <p>
                Our team stays updated with the latest design trends and technologies, ensuring your project incorporates modern solutions. We work with premium suppliers and skilled craftsmen to guarantee that every element meets our exacting standards.
               Specializing in modular near kitchens jlt.</p>

              <h3 className="text-2xl font-bold text-foreground mt-12 mb-4">Investment in Your Space</h3>

              <p>
                Professional Modular Kitchens JLT Dubai is an investment in your property's value and your quality of life. Well-designed spaces command higher property values, improve functionality, and create lasting impressions on clients and visitors.
              </p>

              <p>
                Whether you're renovating your home, opening a new business, or refreshing your existing space, Interiara is your trusted partner for exceptional <strong>Modular Kitchens JLT Dubai</strong>. Contact us today for a free consultation and let's transform your space together.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Why Choose Our Modular Kitchens JLT Dubai Services
            </h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Our Modular Kitchens JLT Dubai Projects
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
