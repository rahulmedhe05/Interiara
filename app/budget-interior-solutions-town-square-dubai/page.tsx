...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Budget Interior Solutions in Town Square, Dubai",
    "url": "https://interiara.com/budget-interior-solutions-town-square",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Budget Interior Solutions",
        "item": "https://interiara.com/budget-interior-solutions-town-square"
      }}
    ]
  }})} />

export const metadata = {
  title: "Budget Interior Solutions in Town Square, Dubai | Interiara",
  description: "Expert budget interior solutions in Town Square, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "budget interior solutions",
    "budget interior solutions Town Square",
  ...
  canonical: "https://interiara.com/budget-interior-solutions-town-square",
  twitter: {
