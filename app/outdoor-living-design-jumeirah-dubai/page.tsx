...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Outdoor Living Design in Jumeirah, Dubai",
    "url": "https://interiara.com/outdoor-living-design-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Outdoor Living Design",
        "item": "https://interiara.com/outdoor-living-design-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Outdoor Living Design in Jumeirah, Dubai | Interiara",
  description: "Beautiful outdoor living design in Jumeirah. Stunning outdoor spaces for relaxation & entertainment. Expert design & build!",
  keywords: [
    "outdoor living design",
    "outdoor living design Jumeirah",
  ...
  canonical: "https://interiara.com/outdoor-living-design-jumeirah",
  twitter: {
