...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Bespoke Furniture Design in JVC, Dubai",
    "url": "https://interiara.com/bespoke-furniture-design-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Bespoke Furniture Design",
        "item": "https://interiara.com/bespoke-furniture-design-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Bespoke Furniture Design in JVC, Dubai | Interiara",
  description: "Expert bespoke furniture design in JVC, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
  ...
  canonical: "https://interiara.com/bespoke-furniture-design-jvc",
  twitter: {
