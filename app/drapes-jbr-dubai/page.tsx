...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Drapes in JBR, Dubai",
    "url": "https://interiara.com/drapes-jbr",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Drapes",
        "item": "https://interiara.com/drapes-jbr"
      }}
    ]
  }})} />

export const metadata = {
  title: "Drapes in JBR, Dubai | Interiara",
  description: "Expert drapes in JBR, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "drapes",
    "drapes JBR",
    "drapes JBR Dubai",
  ...
  canonical: "https://interiara.com/drapes-jbr",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JBR Dubai-with-Accouter-Design.webp", alt: "Drapes JBR Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JBR Dubai-2.jpg", alt: "Drapes JBR Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JBR Dubai.jpg", alt: "Drapes JBR Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JBR Dubai-Top-Interior-Designers.jpeg", alt: "Drapes JBR Dubai - Design inspiration" },
  { src: "/JBR Dubai-Bathroom-Design-2.jpg", alt: "Drapes JBR Dubai - JBR Dubai design" },
...
export default function DrapesJbr() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Drapes JBR Dubai services in JBR Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best  Drapes Jbr Company Drapes Jbr</p>
              ...
              <p className="text-lg text-muted-foreground mb-6 lg:mb-8 leading-relaxed">
                Looking for professional <strong>Drapes JBR Dubai</strong>? Interiara is JBR Dubai's premier <strong>Drapes JBR Dubai company</strong>, specializing in creating beautiful, functional spaces. With 300+ projects completed and 15+ years of experience, we deliver exceptional results tailored to your needs.
              </p>
