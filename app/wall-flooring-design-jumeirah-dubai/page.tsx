...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wall Flooring Design in Jumeirah, Dubai",
    "url": "https://interiara.com/wall-flooring-design-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wall Flooring Design",
        "item": "https://interiara.com/wall-flooring-design-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wall Flooring Design in Jumeirah, Dubai | Interiara",
  description: "Expert wall flooring design in Jumeirah, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wall flooring design",
    "wall flooring design Jumeirah",
  ...
  canonical: "https://interiara.com/wall-flooring-design-jumeirah",
  twitter: {
