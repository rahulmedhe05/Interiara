...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Acoustic Design in Al Safa, Dubai",
    "url": "https://interiara.com/acoustic-design-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Acoustic Design",
        "item": "https://interiara.com/acoustic-design-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Acoustic Design in Al Safa, Dubai | Interiara",
  description: "Expert acoustic design in Al Safa, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "acoustic design",
    "acoustic design Al Safa",
  ...
  canonical: "https://interiara.com/acoustic-design-al-safa",
  twitter: {
