...
export const metadata: Metadata = {
  title: "Salon Interior Design Downtown Dubai | Premium Design Services Downtown Dubai | Interiara",
  description: "Professional salon interior design downtown dubai services in Downtown Dubai. Transform your space with our expert design team. Contact us for a free consultation and custom design proposal.",
  keywords: [
    "salon-interior-design-downtown-dubai", "salon interior design downtown dubai", "salon interior design downtown dubai services", "best salon interior design downtown dubai", "professional salon interior design downtown dubai", "salon interior design downtown dubai company downtown dubai", "salon interior design downtown dubai specialist", "expert salon interior design downtown dubai",
  ],
  openGraph: {
