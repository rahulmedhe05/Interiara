...
// SEO Keywords: Home Renovation Dubai Marina, Home Renovation Dubai Marina Dubai, best Home Renovation in Dubai Marina, professional Home Renovation Dubai Marina, expert Home Renovation Dubai Marina Dubai, Home Renovation services Dubai Marina, Home Renovation company Dubai Marina, Home Renovation specialist Dubai Marina
...
const galleryImages = [
  ...
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Home Renovation Dubai Marina - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Home Renovation Dubai Marina - Professional design" },
]

export const metadata = {
  title: "Home Renovation in Dubai Marina Dubai | Expert Interior Design Services",
  ...
  openGraph: {
    title: "Home Renovation in Dubai Marina Dubai",
    description: "Expert Home Renovation services in Dubai Marina, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Home Renovation in Dubai Marina",
      },
    ],
  },
  robots: "index, follow",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Home Renovation services in Dubai Marina. Please share more details and pricing."
  )
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Home Renovation in Dubai Marina?
...
Dubai Marina residents and businesses benefit from professional home renovation that considers:
...
Our Dubai Marina team understands these unique factors, delivering home renovation solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Home Renovation in Dubai Marina?
...
Professional home renovation in Dubai Marina offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert home renovation can create your perfect Dubai Marina environment. Schedule your free consultation now.
          </p>
