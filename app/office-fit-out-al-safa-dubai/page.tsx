...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Office Fit Out in Al Safa, Dubai",
    "url": "https://interiara.com/office-fit-out-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Office Fit Out",
        "item": "https://interiara.com/office-fit-out-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Office Fit Out in Al Safa, Dubai | Interiara",
  description: "Complete office fit out services in Al Safa. Professional execution & quality assurance. Fast turnaround. Consult now!",
  keywords: [
    "office fit out",
    "office fit out Al Safa",
  ...
  canonical: "https://interiara.com/office-fit-out-al-safa",
  twitter: {
