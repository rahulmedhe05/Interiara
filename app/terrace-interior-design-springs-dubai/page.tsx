...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Terrace Interior Design in Springs, Dubai",
    "url": "https://interiara.com/terrace-interior-design-springs",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Terrace Interior Design",
        "item": "https://interiara.com/terrace-interior-design-springs"
      }}
    ]
  }})} />

export const metadata = {
  title: "Terrace Interior Design in Springs, Dubai | Interiara",
  description: "Transform your space with premium terrace interior design in Springs. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "terrace interior design",
    "terrace interior design Springs",
  ...
  canonical: "https://interiara.com/terrace-interior-design-springs",
  twitter: {
