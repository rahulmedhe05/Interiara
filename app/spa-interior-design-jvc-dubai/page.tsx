...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Spa Interior Design in JVC, Dubai",
    "url": "https://interiara.com/spa-interior-design-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Spa Interior Design",
        "item": "https://interiara.com/spa-interior-design-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Spa Interior Design in JVC, Dubai | Interiara",
  description: "Transform your space with premium spa interior design in JVC. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "spa interior design",
  ...
  canonical: "https://interiara.com/spa-interior-design-jvc",
  twitter: {
