...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Kitchen Interior Design in Dubai Festival City, Dubai",
    "url": "https://interiara.com/kitchen-interior-design-dubai-festival-city",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Kitchen Interior Design",
        "item": "https://interiara.com/kitchen-interior-design-dubai-festival-city"
      }}
    ]
  }})} />

export const metadata = {
  title: "Kitchen Interior Design in Dubai Festival City, Dubai | Interiara",
  description: "Transform your space with premium kitchen interior design in Dubai Festival City. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/kitchen-interior-design-dubai-festival-city",
  twitter: {
