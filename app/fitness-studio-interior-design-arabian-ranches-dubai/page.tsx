...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Fitness Studio Interior Design in Arabian Ranches, Dubai",
    "url": "https://interiara.com/fitness-studio-interior-design-arabian-ranches",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Fitness Studio Interior Design",
        "item": "https://interiara.com/fitness-studio-interior-design-arabian-ranches"
      }}
    ]
  }})} />

export const metadata = {
  title: "Fitness Studio Interior Design in Arabian Ranches, Dubai | Interiara",
  description: "Transform your space with premium fitness studio interior design in Arabian Ranches. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "fitness studio interior design",
    "fitness studio interior design Arabian Ranches",
  ...
  canonical: "https://interiara.com/fitness-studio-interior-design-arabian-ranches",
  twitter: {
