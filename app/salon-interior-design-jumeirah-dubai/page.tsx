...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Salon Interior Design in Jumeirah, Dubai",
    "url": "https://interiara.com/salon-interior-design-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Salon Interior Design",
        "item": "https://interiara.com/salon-interior-design-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Salon Interior Design in Jumeirah, Dubai | Interiara",
  description: "Transform your space with premium salon interior design in Jumeirah. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "salon interior design",
    "salon interior design Jumeirah",
  ...
  canonical: "https://interiara.com/salon-interior-design-jumeirah",
  twitter: {
