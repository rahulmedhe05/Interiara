...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wall Coverings in Al Barsha, Dubai",
    "url": "https://interiara.com/wall-coverings-al-barsha",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wall Coverings",
        "item": "https://interiara.com/wall-coverings-al-barsha"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wall Coverings in Al Barsha, Dubai | Interiara",
  description: "Expert wall coverings in Al Barsha, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wall coverings",
    "wall coverings Al Barsha",
  ...
  canonical: "https://interiara.com/wall-coverings-al-barsha",
  twitter: {
