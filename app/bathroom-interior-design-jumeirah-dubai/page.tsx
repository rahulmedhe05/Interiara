...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Bathroom Interior Design in Jumeirah, Dubai",
    "url": "https://interiara.com/bathroom-interior-design-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Bathroom Interior Design",
        "item": "https://interiara.com/bathroom-interior-design-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Bathroom Interior Design in Jumeirah, Dubai | Interiara",
  description: "Transform your space with premium bathroom interior design in Jumeirah. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "bathroom interior design",
    "bathroom interior design Jumeirah",
  ...
  canonical: "https://interiara.com/bathroom-interior-design-jumeirah",
  twitter: {
