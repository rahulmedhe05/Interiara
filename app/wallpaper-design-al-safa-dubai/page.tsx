...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wallpaper Design in Al Safa, Dubai",
    "url": "https://interiara.com/wallpaper-design-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wallpaper Design",
        "item": "https://interiara.com/wallpaper-design-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wallpaper Design in Al Safa, Dubai | Interiara",
  description: "Expert wallpaper design in Al Safa, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wallpaper design",
    "wallpaper design Al Safa",
  ...
  canonical: "https://interiara.com/wallpaper-design-al-safa",
  twitter: {
