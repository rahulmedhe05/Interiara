...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Residential Interior Design in Town Square, Dubai",
    "url": "https://interiara.com/residential-interior-design-town-square",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Residential Interior Design",
        "item": "https://interiara.com/residential-interior-design-town-square"
      }}
    ]
  }})} />

export const metadata = {
  title: "Residential Interior Design in Town Square, Dubai | Interiara",
  description: "Transform your space with premium residential interior design in Town Square. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "residential interior design",
    "residential interior design Town Square",
  ...
  canonical: "https://interiara.com/residential-interior-design-town-square",
  twitter: {
