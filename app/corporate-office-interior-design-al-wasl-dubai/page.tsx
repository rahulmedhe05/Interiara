...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Corporate Office Interior Design in Al Wasl, Dubai",
    "url": "https://interiara.com/corporate-office-interior-design-al-wasl",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Corporate Office Interior Design",
        "item": "https://interiara.com/corporate-office-interior-design-al-wasl"
      }}
    ]
  }})} />

export const metadata = {
  title: "Corporate Office Interior Design in Al Wasl, Dubai | Interiara",
  description: "Transform your space with premium corporate office interior design in Al Wasl. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "corporate office interior design",
    "corporate office interior design Al Wasl",
  ...
  canonical: "https://interiara.com/corporate-office-interior-design-al-wasl",
  twitter: {
