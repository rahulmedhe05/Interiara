...
const galleryImages = [
  ...
  { src: "/Reception-9.jpg", alt: "Modular Kitchens Emirates Hills - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Modular Kitchens Emirates Hills - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Modular Kitchens Emirates Hills - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Modular Kitchens Emirates Hills - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Modular Kitchens Emirates Hills - Professional design" },
]

export const metadata = {
  title: "Modular Kitchens in Emirates Hills Dubai | Expert Interior Design Services",
  ...
  keywords: "Modular Kitchens Emirates Hills, Modular Kitchens Emirates Hills Dubai, best Modular Kitchens in Emirates Hills, professional Modular Kitchens Emirates Hills, expert Modular Kitchens Emirates Hills Dubai, Modular Kitchens services Emirates Hills, Modular Kitchens company Emirates Hills, Modular Kitchens specialist Emirates Hills",
  openGraph: {
    title: "Modular Kitchens in Emirates Hills Dubai",
    description: "Expert Modular Kitchens services in Emirates Hills, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Modular Kitchens in Emirates Hills",
      },
    ],
  },
  robots: "index, follow",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Modular Kitchens services in Emirates Hills. Please share more details and pricing."
  )
          ...
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed whitespace-pre-line">
                Discover modern, functional kitchen solutions with our expert modular kitchen design and installation services in Emirates Hills. We create smart, space-efficient kitchens that combine style with practicality. Perfect for Emirates Hills homes seeking contemporary culinary spaces.
              </p>
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Modular Kitchens in Emirates Hills?

Our modular kitchen services provide contemporary, functional kitchen designs. We create Emirates Hills kitchens that balance aesthetics with smart functionality and storage optimization.
...
Emirates Hills residents and businesses benefit from professional modular kitchens that considers:
...
Our Emirates Hills team understands these unique factors, delivering modular kitchens solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Modular Kitchens in Emirates Hills?
...
Professional modular kitchens in Emirates Hills offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert modular kitchens can create your perfect Emirates Hills environment. Schedule your free consultation now.
          </p>
