...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wallpaper Design in City Walk, Dubai",
    "url": "https://interiara.com/wallpaper-design-city-walk",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wallpaper Design",
        "item": "https://interiara.com/wallpaper-design-city-walk"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wallpaper Design in City Walk, Dubai | Interiara",
  description: "Expert wallpaper design in City Walk, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wallpaper design",
    "wallpaper design City Walk",
  ...
  canonical: "https://interiara.com/wallpaper-design-city-walk",
  twitter: {
