...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Space Optimization in The Villa, Dubai",
    "url": "https://interiara.com/interior-space-optimization-the-villa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Space Optimization",
        "item": "https://interiara.com/interior-space-optimization-the-villa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Space Optimization in The Villa, Dubai | Interiara",
  description: "Expert interior space optimization in The Villa, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
  ...
  canonical: "https://interiara.com/interior-space-optimization-the-villa",
  twitter: {
