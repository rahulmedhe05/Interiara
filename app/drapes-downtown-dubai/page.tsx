...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-Downtown Dubai-with-Accouter-Design.webp", alt: "Drapes Downtown Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-Downtown Dubai-2.jpg", alt: "Drapes Downtown Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-Downtown Dubai.jpg", alt: "Drapes Downtown Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-Downtown Dubai-Top-Interior-Designers.jpeg", alt: "Drapes Downtown Dubai - Design inspiration" },
  { src: "/Downtown Dubai-Bathroom-Design-2.jpg", alt: "Drapes Downtown Dubai - Downtown Dubai design" },
...
export default function DrapesDowntown() {
  const [showAllImages, setShowAllImages] = useState(false)
  const whatsappNumber = "916353583148"
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Drapes Downtown Dubai services in Downtown Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best  Drapes Downtown Company Drapes Downtown</p>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">
              All Drapes Downtown Services
            </h2>
            <p className="text-muted-foreground mb-8">
              Explore our complete range of interior design services available in Drapes Downtown. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-3">
              <Link href="/drapes-downtown-dubai" className="block text-primary hover:text-primary-dark hover:underline transition-colors duration-200 text-sm font-medium">
          ...
          <div className="mt-12 pt-8 border-t">
            <p className="text-center text-sm text-muted-foreground">
              Looking for a specific service in Drapes Downtown? 
