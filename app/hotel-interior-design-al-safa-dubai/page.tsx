...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Hotel Interior Design in Al Safa, Dubai",
    "url": "https://interiara.com/hotel-interior-design-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Hotel Interior Design",
        "item": "https://interiara.com/hotel-interior-design-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Hotel Interior Design in Al Safa, Dubai | Interiara",
  description: "Transform your space with premium hotel interior design in Al Safa. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "hotel interior design",
    "hotel interior design Al Safa",
  ...
  canonical: "https://interiara.com/hotel-interior-design-al-safa",
  twitter: {
