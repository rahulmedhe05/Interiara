...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Closet Design in Jumeirah, Dubai",
    "url": "https://interiara.com/closet-design-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Closet Design",
        "item": "https://interiara.com/closet-design-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Closet Design in Jumeirah, Dubai | Interiara",
  description: "Expert closet design in Jumeirah, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "closet design",
    "closet design Jumeirah",
  ...
  canonical: "https://interiara.com/closet-design-jumeirah",
  twitter: {
