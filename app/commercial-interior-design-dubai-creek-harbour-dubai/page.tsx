...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Commercial Interior Design in Dubai Creek Harbour, Dubai",
    "url": "https://interiara.com/commercial-interior-design-dubai-creek-harbour",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Commercial Interior Design",
        "item": "https://interiara.com/commercial-interior-design-dubai-creek-harbour"
      }}
    ]
  }})} />

export const metadata = {
  title: "Commercial Interior Design in Dubai Creek Harbour, Dubai | Interiara",
  description: "Transform your space with premium commercial interior design in Dubai Creek Harbour. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/commercial-interior-design-dubai-creek-harbour",
  twitter: {
