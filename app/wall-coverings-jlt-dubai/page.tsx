...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wall Coverings in JLT, Dubai",
    "url": "https://interiara.com/wall-coverings-jlt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wall Coverings",
        "item": "https://interiara.com/wall-coverings-jlt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wall Coverings in JLT, Dubai | Interiara",
  description: "Expert wall coverings in JLT, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wall coverings",
    "wall coverings JLT",
  ...
  canonical: "https://interiara.com/wall-coverings-jlt",
  twitter: {
...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JLT Dubai-with-Accouter-Design.webp", alt: "Wall Coverings JLT Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JLT Dubai-2.jpg", alt: "Wall Coverings JLT Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JLT Dubai.jpg", alt: "Wall Coverings JLT Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JLT Dubai-Top-Interior-Designers.jpeg", alt: "Wall Coverings JLT Dubai - Design inspiration" },
  { src: "/JLT Dubai-Bathroom-Design-2.jpg", alt: "Wall Coverings JLT Dubai - JLT Dubai design" },
...
export default function WallCoveringsJlt() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Wall Coverings JLT Dubai services in JLT Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best wall Coverings Jlt Company Coverings Jlt</p>
