...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Interior Space Optimization in Al Quoz, Dubai",
    "url": "https://interiara.com/interior-space-optimization-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Interior Space Optimization",
        "item": "https://interiara.com/interior-space-optimization-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Interior Space Optimization in Al Quoz, Dubai | Interiara",
  description: "Expert interior space optimization in Al Quoz, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "interior space optimization",
    "interior space optimization Al Quoz",
  ...
  canonical: "https://interiara.com/interior-space-optimization-al-quoz",
  twitter: {
