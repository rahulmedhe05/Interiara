...
const galleryImages = [
  { src: "/dubai-interior-design-luxury.jpg", alt: "Home Renovation JVC Dubai - Luxury design" },
  { src: "/Reception-9.jpg", alt: "Home Renovation JVC Dubai - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Home Renovation JVC Dubai - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Home Renovation JVC Dubai - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Home Renovation JVC Dubai - Lighting design" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Home Renovation JVC Dubai - Professional design" },
  { src: "/dubai-luxury-interior-design-585x734.jpg", alt: "Home Renovation JVC Dubai - Luxury spaces" },
  { src: "/Villa-interior-design-JVC Dubai-with-Accouter-Design.webp", alt: "Home Renovation JVC Dubai - Premium interiors" },
  { src: "/meet.jpg", alt: "Home Renovation JVC Dubai - Modern design" },
  { src: "/2b-scaled.jpg", alt: "Home Renovation JVC Dubai - Custom design" },
  { src: "/DSC01457-min-scaled.webp", alt: "Home Renovation JVC Dubai - Expert execution" },
  { src: "/98488683052973.5d304d1b15e83.jpg", alt: "Home Renovation JVC Dubai - Quality finishes" },
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JVC Dubai-2.jpg", alt: "Home Renovation JVC Dubai - Functional design" },
  { src: "/Al-Barari-Kitchen.jpg", alt: "Home Renovation JVC Dubai - Premium fixtures" },
  { src: "/kitchen-aesthetic-harmony-modern-luxury-fusion-interior-design-dream-home-1-min.jpg", alt: "Home Renovation JVC Dubai - Aesthetic design" },
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JVC Dubai.jpg", alt: "Home Renovation JVC Dubai - Space planning" },
  { src: "/9f76af35953159a45c406d49cb9bc4d0.jpg", alt: "Home Renovation JVC Dubai - Design excellence" },
  { src: "/Zen_PalmD1_07b-scaled-1.jpg", alt: "Home Renovation JVC Dubai - Serene spaces" },
  { src: "/1-Unique-Bathroom-Projects.jpg", alt: "Home Renovation JVC Dubai - Unique projects" },
  { src: "/8-Bathroom-Inspiration-By-JVC Dubai-Top-Interior-Designers.jpeg", alt: "Home Renovation JVC Dubai - Design inspiration" },
  { src: "/JVC Dubai-Bathroom-Design-2.jpg", alt: "Home Renovation JVC Dubai - JVC Dubai design" },
  { src: "/bathroom-1024x683.jpg", alt: "Home Renovation JVC Dubai - Luxury bathroom" },
  { src: "/gf-ktchen-view2.jpg", alt: "Home Renovation JVC Dubai - Kitchen design" },
  { src: "/10-Stunning-Kitchen-Island-Designs-to-Elevate-Your-Culinary-Space.jpeg", alt: "Home Renovation JVC Dubai - Island designs" },
]

export default function HomeRenovationJvc() {
  const [showAllImages, setShowAllImages] = useState(false)
  const whatsappNumber = "916353583148"
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Home Renovation JVC Dubai services in JVC Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best home Renovation Jvc Company Renovation Jvc</p>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 leading-tight">
                Expert Home Renovation JVC Dubai - <span className="text-primary">Transform Your Space</span>
              </h1>
              <p className="text-lg text-muted-foreground mb-6 lg:mb-8 leading-relaxed">
                Looking for professional <strong>Home Renovation JVC Dubai</strong>? Interiara is JVC Dubai's premier <strong>Home Renovation JVC Dubai company</strong>, specializing in creating beautiful, functional spaces. With 300+ projects completed and 15+ years of experience, we deliver exceptional results tailored to your needs.
              </p>
              ...
              <div className="relative mb-8 hidden lg:block">
                <div className="aspect-[16/9] rounded-2xl overflow-hidden shadow-2xl">
                  <img 
                    ...
                    alt="Home Renovation JVC Dubai by Interiara"
            ...
            <div className="lg:col-span-2 order-2 lg:order-none w-full">
              <ServicePageForm serviceName="Home Renovation JVC Dubai" />
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 text-center">
              Why Choose Interiara for Home Renovation JVC Dubai?
            </h2>
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
              ...
              <p>
                Our <strong>Home Renovation JVC Dubai</strong> services include:
              </p>
              ...
              <p>
                Professional Home Renovation JVC Dubai is an investment in your property's value and your quality of life. Well-designed spaces command higher property values, improve functionality, and create lasting impressions on clients and visitors.
              </p>

              <p>
                Whether you're renovating your home, opening a new business, or refreshing your existing space, Interiara is your trusted partner for exceptional <strong>Home Renovation JVC Dubai</strong>. Contact us today for a free consultation and let's transform your space together.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Why Choose Our Home Renovation JVC Dubai Services
            </h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Our Home Renovation JVC Dubai Projects
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
