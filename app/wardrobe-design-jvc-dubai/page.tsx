...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wardrobe Design in JVC, Dubai",
    "url": "https://interiara.com/wardrobe-design-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wardrobe Design",
        "item": "https://interiara.com/wardrobe-design-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wardrobe Design in JVC, Dubai | Interiara",
  description: "Custom wardrobe design in JVC. Bespoke wardrobes designed for your space. Professional installation. Consult now!",
  keywords: [
    "wardrobe design",
    "wardrobe design JVC",
  ...
  canonical: "https://interiara.com/wardrobe-design-jvc",
  twitter: {
