...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Luxury Interior Design in Al Furjan, Dubai",
    "url": "https://interiara.com/luxury-interior-design-al-furjan",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Luxury Interior Design",
        "item": "https://interiara.com/luxury-interior-design-al-furjan"
      }}
    ]
  }})} />

export const metadata = {
  title: "Luxury Interior Design in Al Furjan, Dubai | Interiara",
  description: "Transform your space with premium luxury interior design in Al Furjan. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "luxury interior design",
    "luxury interior design Al Furjan",
  ...
  canonical: "https://interiara.com/luxury-interior-design-al-furjan",
  twitter: {
