...
// SEO Keywords: Space Planning Town Square, Space Planning Town Square Dubai, best Space Planning in Town Square, professional Space Planning Town Square, expert Space Planning Town Square Dubai, Space Planning services Town Square, Space Planning company Town Square, Space Planning specialist Town Square
...
const galleryImages = [
  ...
  { src: "/Reception-9.jpg", alt: "Space Planning Town Square - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Space Planning Town Square - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Space Planning Town Square - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Space Planning Town Square - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Space Planning Town Square - Professional design" },
]

export const metadata = {
  title: "Space Planning in Town Square Dubai | Expert Interior Design Services",
  ...
  keywords: "Space Planning Town Square, Space Planning Town Square Dubai, best Space Planning in Town Square, professional Space Planning Town Square, expert Space Planning Town Square Dubai, Space Planning services Town Square, Space Planning company Town Square, Space Planning specialist Town Square",
  openGraph: {
    title: "Space Planning in Town Square Dubai",
    description: "Expert Space Planning services in Town Square, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Space Planning in Town Square",
      },
    ],
  },
  robots: "index, follow",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Space Planning services in Town Square. Please share more details and pricing."
  )
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Space Planning in Town Square?
...
Town Square residents and businesses benefit from professional space planning that considers:
...
Our Town Square team understands these unique factors, delivering space planning solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Space Planning in Town Square?
...
Professional space planning in Town Square offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert space planning can create your perfect Town Square environment. Schedule your free consultation now.
          </p>
