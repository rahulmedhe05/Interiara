...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Balcony Interior Design in Palm Jumeirah, Dubai",
    "url": "https://interiara.com/balcony-interior-design-palm-jumeirah",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Balcony Interior Design",
        "item": "https://interiara.com/balcony-interior-design-palm-jumeirah"
      }}
    ]
  }})} />

export const metadata = {
  title: "Balcony Interior Design in Palm Jumeirah, Dubai | Interiara",
  description: "Transform your space with premium balcony interior design in Palm Jumeirah. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "balcony interior design",
    "balcony interior design Palm Jumeirah",
  ...
  canonical: "https://interiara.com/balcony-interior-design-palm-jumeirah",
  twitter: {
