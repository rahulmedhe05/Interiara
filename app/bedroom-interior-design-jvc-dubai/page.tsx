...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Bedroom Interior Design in JVC, Dubai",
    "url": "https://interiara.com/bedroom-interior-design-jvc",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Bedroom Interior Design",
        "item": "https://interiara.com/bedroom-interior-design-jvc"
      }}
    ]
  }})} />

export const metadata = {
  title: "Bedroom Interior Design in JVC, Dubai | Interiara",
  description: "Transform your space with premium bedroom interior design in JVC. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/bedroom-interior-design-jvc",
  twitter: {
