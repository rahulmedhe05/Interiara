...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Bathroom Interior Design in JVT, Dubai",
    "url": "https://interiara.com/bathroom-interior-design-jvt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Bathroom Interior Design",
        "item": "https://interiara.com/bathroom-interior-design-jvt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Bathroom Interior Design in JVT, Dubai | Interiara",
  description: "Transform your space with premium bathroom interior design in JVT. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
    "bathroom interior design",
    "bathroom interior design JVT",
  ...
  canonical: "https://interiara.com/bathroom-interior-design-jvt",
  twitter: {
