...
const galleryImages = [
  ...
  { src: "/Villa-interior-design-JBR Dubai-with-Accouter-Design.webp", alt: "Modular Kitchens JBR Dubai - Premium interiors" },
  ...
  { src: "/Color-Scheme-Modular-kitchen-Interior-Design-and-Fit-Out-DesignMaster-JBR Dubai-2.jpg", alt: "Modular Kitchens JBR Dubai - Functional design" },
  ...
  { src: "/L-Shaped-Modern-kitchen-Layout-DesignMaster-JBR Dubai.jpg", alt: "Modular Kitchens JBR Dubai - Space planning" },
  ...
  { src: "/8-Bathroom-Inspiration-By-JBR Dubai-Top-Interior-Designers.jpeg", alt: "Modular Kitchens JBR Dubai - Design inspiration" },
  { src: "/JBR Dubai-Bathroom-Design-2.jpg", alt: "Modular Kitchens JBR Dubai - JBR Dubai design" },
...
export default function ModularKitchensJbr() {
  ...
  const whatsappMessage = encodeURIComponent("Hi Interiara! I'm interested in Modular Kitchens JBR Dubai services in JBR Dubai. Please share more details.")
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-3 order-1 lg:order-none">
              <p className="text-accent font-mono uppercase tracking-wider mb-4">Best modular Kitchens Jbr Company Kitchens Jbr</p>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4">
              All Kitchens Jbr Services
            </h2>
            <p className="text-muted-foreground mb-8">
              Explore our complete range of interior design services available in Kitchens Jbr. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-3">
              <Link href="/modular-kitchens-jbr-dubai" className="block text-primary hover:text-primary-dark hover:underline transition-colors duration-200 text-sm font-medium">
                Modular
              </Link>
            </div>
            <div className="space-y-3">
          ...
          <div className="mt-12 pt-8 border-t">
            <p className="text-center text-sm text-muted-foreground">
              Looking for a specific service in Kitchens Jbr? 
