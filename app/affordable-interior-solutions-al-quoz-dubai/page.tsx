...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Affordable Interior Solutions in Al Quoz, Dubai",
    "url": "https://interiara.com/affordable-interior-solutions-al-quoz",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Affordable Interior Solutions",
        "item": "https://interiara.com/affordable-interior-solutions-al-quoz"
      }}
    ]
  }})} />

export const metadata = {
  title: "Affordable Interior Solutions in Al Quoz, Dubai | Interiara",
  description: "Expert affordable interior solutions in Al Quoz, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "affordable interior solutions",
    "affordable interior solutions Al Quoz",
  ...
  canonical: "https://interiara.com/affordable-interior-solutions-al-quoz",
  twitter: {
