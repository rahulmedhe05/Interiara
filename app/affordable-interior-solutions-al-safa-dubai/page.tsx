...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Affordable Interior Solutions in Al Safa, Dubai",
    "url": "https://interiara.com/affordable-interior-solutions-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Affordable Interior Solutions",
        "item": "https://interiara.com/affordable-interior-solutions-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Affordable Interior Solutions in Al Safa, Dubai | Interiara",
  description: "Expert affordable interior solutions in Al Safa, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "affordable interior solutions",
    "affordable interior solutions Al Safa",
  ...
  canonical: "https://interiara.com/affordable-interior-solutions-al-safa",
  twitter: {
