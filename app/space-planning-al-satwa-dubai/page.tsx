...
// SEO Keywords: Space Planning Al Satwa, Space Planning Al Satwa Dubai, best Space Planning in Al Satwa, professional Space Planning Al Satwa, expert Space Planning Al Satwa Dubai, Space Planning services Al Satwa, Space Planning company Al Satwa, Space Planning specialist Al Satwa
...
const galleryImages = [
  ...
  { src: "/Reception-9.jpg", alt: "Space Planning Al Satwa - Modern space" },
  { src: "/Modern-Eclectic-3-1.webp", alt: "Space Planning Al Satwa - Contemporary style" },
  { src: "/Top-Living-Room-Decor.png", alt: "Space Planning Al Satwa - Elegant interior" },
  { src: "/hera-suspension-lamp-04-zoom-boca-do-lobo-1-1-1400x933.jpg", alt: "Space Planning Al Satwa - Design detail" },
  { src: "/top-interior-designers-dubai.jpg", alt: "Space Planning Al Satwa - Professional design" },
]

export const metadata = {
  title: "Space Planning in Al Satwa Dubai | Expert Interior Design Services",
  ...
  keywords: "Space Planning Al Satwa, Space Planning Al Satwa Dubai, best Space Planning in Al Satwa, professional Space Planning Al Satwa, expert Space Planning Al Satwa Dubai, Space Planning services Al Satwa, Space Planning company Al Satwa, Space Planning specialist Al Satwa",
  openGraph: {
    title: "Space Planning in Al Satwa Dubai",
    description: "Expert Space Planning services in Al Satwa, Dubai. Professional design team with 15+ years experience. Get free consultation today!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Space Planning in Al Satwa",
      },
    ],
  },
  robots: "index, follow",
...
export default function ServicePage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi Interiara! I'm interested in Space Planning services in Al Satwa. Please share more details and pricing."
  )
      ...
      <section className="py-16 md:py-24 border-b bg-muted">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>What is Space Planning in Al Satwa?
...
Al Satwa residents and businesses benefit from professional space planning that considers:
...
Our Al Satwa team understands these unique factors, delivering space planning solutions that perfectly fit your needs.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <p>Why Choose Professional Space Planning in Al Satwa?
...
Professional space planning in Al Satwa offers specific community advantages:
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Discover how our expert space planning can create your perfect Al Satwa environment. Schedule your free consultation now.
          </p>
