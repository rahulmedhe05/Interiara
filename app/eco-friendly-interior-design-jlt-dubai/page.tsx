...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Eco Friendly Interior Design in JLT, Dubai",
    "url": "https://interiara.com/eco-friendly-interior-design-jlt",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Eco Friendly Interior Design",
        "item": "https://interiara.com/eco-friendly-interior-design-jlt"
      }}
    ]
  }})} />

export const metadata = {
  title: "Eco Friendly Interior Design in JLT, Dubai | Interiara",
  description: "Transform your space with premium eco friendly interior design in JLT. Award-winning designs for homes & offices. Contact us for free consultation.",
  keywords: [
  ...
  canonical: "https://interiara.com/eco-friendly-interior-design-jlt",
  twitter: {
