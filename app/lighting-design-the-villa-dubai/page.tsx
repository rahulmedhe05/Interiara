...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Lighting Design in The Villa, Dubai",
    "url": "https://interiara.com/lighting-design-the-villa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Lighting Design",
        "item": "https://interiara.com/lighting-design-the-villa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Lighting Design in The Villa, Dubai | Interiara",
  description: "Professional lighting design in The Villa. Enhance ambiance & functionality with expert lighting. Free consultation available!",
  keywords: [
    "lighting design",
  ...
  canonical: "https://interiara.com/lighting-design-the-villa",
  twitter: {
