...
<script
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "@type": "LocalBusiness",
    "name": "Interiara",
    "description": "Wall Flooring Design in Al Safa, Dubai",
    "url": "https://interiara.com/wall-flooring-design-al-safa",
  ...
  dangerouslySetInnerHTML={{__html: JSON.stringify({{
    ...
    "itemListElement": [
      ...
      {{
        ...
        "position": 3,
        "name": "Wall Flooring Design",
        "item": "https://interiara.com/wall-flooring-design-al-safa"
      }}
    ]
  }})} />

export const metadata = {
  title: "Wall Flooring Design in Al Safa, Dubai | Interiara",
  description: "Expert wall flooring design in Al Safa, Dubai. Premium design & professional execution. 300+ projects completed. Book your free consultation!",
  keywords: [
    "wall flooring design",
    "wall flooring design Al Safa",
  ...
  canonical: "https://interiara.com/wall-flooring-design-al-safa",
  twitter: {
